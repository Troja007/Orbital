...
This repository is also intended to be usable as source material for a Codex workspace around Cisco Orbital query and script work.

Codex can use this repository to understand and reuse:
...
- Do not modify `custom_queries` or `custom_scripts` unless the GitHub-backed work should intentionally change.
...
For a larger Codex project, this repository can be used as the `01_Source_Files/GitHub` source mirror inside a workspace with this structure:
...
The parent Codex workspace can include additional context files and `AGENTS.md`. This GitHub repository remains the source mirror for Orbital queries and scripts.
