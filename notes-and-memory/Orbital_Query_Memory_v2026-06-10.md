...
```text
02_Working_Files/Query_Methods/_template.yaml
```
...
```text
02_Working_Files/Query_Methods/network/hosts_file_entries.yaml
```
...
```text
02_Working_Files/Query_Methods/orbital_health/computer_name_inventory.yaml
```
...
```text
02_Working_Files/Query_Methods/orbital_health/operating_system_inventory.yaml
```
...
```text
02_Working_Files/Query_Methods/suspicious_processes/running_process_sha256_from_catalog.yaml
```
...
```text
02_Working_Files/Query_Methods/suspicious_processes/windows_sfc_running_process.yaml
```
