...
| 2026-07-02 | Keep query answers compact and traceable by default while still using the full project capability stack internally. | `2026-07-02_compact_query_responses_full_capability.md` |
