# Windows Event Logs: Private Key Access Monitoring

## Catalog Identity

- Catalog ID: `windows_eventlogs_private_key_access`
- Catalog name: `Windows Event Logs: Private Key Access Monitoring`
- Platform: windows
