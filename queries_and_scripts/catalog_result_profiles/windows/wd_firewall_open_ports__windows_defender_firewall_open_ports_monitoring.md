# Windows Defender Firewall Open Ports Monitoring

## Catalog Identity

- Catalog ID: `wd_firewall_open_ports`
- Catalog name: `Windows Defender Firewall Open Ports Monitoring`
- Platform: windows
...
- Observed row count: 53
- Row-count bucket: `medium_11_100`
- Returned labels:
- `wd_firewall_open_ports`

Observed columns:

| Label | Columns |
| --- | --- |
| `wd_firewall_open_ports` | `Firewall Rule Name`, `Open Local Port`, `Open Remote Port`, `Open Local Port 2-10`, `Open Remote Port 2-10`, `Open Local Port 2-20` |

Label row counts:
- `wd_firewall_open_ports`: 53

## How To Read The Result

Observed validation result:

The endpoint answered and returned 53 rows in the validation run.
...
Catalog warnings:
- This does not include IP-HTTPS ports.
