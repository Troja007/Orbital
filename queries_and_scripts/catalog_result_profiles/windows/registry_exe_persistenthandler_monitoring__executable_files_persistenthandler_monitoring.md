# Executable Files PersistentHandler Monitoring

## Catalog Identity

- Catalog ID: `registry_exe_persistenthandler_monitoring`
- Catalog name: `Executable Files PersistentHandler Monitoring`
- Platform: windows
