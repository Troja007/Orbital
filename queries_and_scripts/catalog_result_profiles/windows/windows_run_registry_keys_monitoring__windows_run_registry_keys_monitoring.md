# Windows Run Registry Keys Monitoring

## Catalog Identity

- Catalog ID: `windows_run_registry_keys_monitoring`
- Catalog name: `Windows Run Registry Keys Monitoring`
- Platform: windows
...
- Returned labels:
- `autorun_registry_keys_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `autorun_registry_keys_monitoring` | `last_modified`, `reg_key`, `name`, `data` |

Label row counts:
- `autorun_registry_keys_monitoring`: 6
