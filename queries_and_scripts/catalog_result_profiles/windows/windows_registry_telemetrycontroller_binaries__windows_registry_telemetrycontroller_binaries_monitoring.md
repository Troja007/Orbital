# Windows Registry TelemetryController Binaries Monitoring

## Catalog Identity

- Catalog ID: `windows_registry_telemetrycontroller_binaries`
- Catalog name: `Windows Registry TelemetryController Binaries Monitoring`
- Platform: windows
