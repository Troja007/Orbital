# Physical Disk Performance Monitoring

## Catalog Identity

- Catalog ID: `windows_physical_disk_performance_monitoring`
- Catalog name: `Physical Disk Performance Monitoring`
- Platform: windows
