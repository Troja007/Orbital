# Process Children Search

## Catalog Identity

- Catalog ID: `process_children_parameterized_search`
- Catalog name: `Process Children Search`
...
- Observed row count: 146
- Row-count bucket: `high_101_1000`
- Returned labels:
- `process_children_search`

Observed columns:

| Label | Columns |
| --- | --- |
| `process_children_search` | `pid`, `name`, `path`, `cmdline`, `cwd`, `uid`, `gid`, `on_disk`, `total_size` |

Label row counts:
- `process_children_search`: 146

## How To Read The Result

Observed validation result:

The endpoint answered and returned 146 rows in the validation run.
