# Windows WMI Software Licensing Product

## Catalog Identity

- Catalog ID: `windows_wmi_software_licensing_product`
- Catalog name: `Windows WMI Software Licensing Product`
- Platform: windows
...
- Observed row count: 75
- Row-count bucket: `medium_11_100`
- Returned labels:
- `windows_wmi_software_licensing_product`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_wmi_software_licensing_product` | `Name`, `license_status`, `LicenseFamily`, `ProductKeyID` |

Label row counts:
- `windows_wmi_software_licensing_product`: 75

## How To Read The Result

Observed validation result:

The endpoint answered and returned 75 rows in the validation run.
