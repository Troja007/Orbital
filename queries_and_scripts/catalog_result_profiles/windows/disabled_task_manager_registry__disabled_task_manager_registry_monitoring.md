# Disabled Task Manager Registry Monitoring

## Catalog Identity

- Catalog ID: `disabled_task_manager_registry`
- Catalog name: `Disabled Task Manager Registry Monitoring`
- Platform: windows
