# Windows Event Logs Wrong Password Kerberos Pre-Authentication Fails

## Catalog Identity

- Catalog ID: `windows_eventlogs_kerberos_preauthentication_fail`
- Catalog name: `Windows Event Logs Wrong Password Kerberos Pre-Authentication Fails`
- Platform: windows
