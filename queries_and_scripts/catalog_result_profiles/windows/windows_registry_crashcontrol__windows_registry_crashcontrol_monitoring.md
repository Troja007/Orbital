# Windows Registry CrashControl Monitoring

## Catalog Identity

- Catalog ID: `windows_registry_crashcontrol`
- Catalog name: `Windows Registry CrashControl Monitoring`
- Platform: windows
