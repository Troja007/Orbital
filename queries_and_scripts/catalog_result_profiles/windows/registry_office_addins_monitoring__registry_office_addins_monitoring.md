# Registry Office Addins Monitoring

## Catalog Identity

- Catalog ID: `registry_office_addins_monitoring`
- Catalog name: `Registry Office Addins Monitoring`
- Platform: windows
...
- Returned labels:
- `registry_office_addins_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `registry_office_addins_monitoring` | `reg_key`, `path`, `name`, `data`, `last_modified` |

Label row counts:
- `registry_office_addins_monitoring`: 2
