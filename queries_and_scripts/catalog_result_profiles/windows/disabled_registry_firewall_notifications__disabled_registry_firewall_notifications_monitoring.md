# Disabled Registry Firewall Notifications Monitoring

## Catalog Identity

- Catalog ID: `disabled_registry_firewall_notifications`
- Catalog name: `Disabled Registry Firewall Notifications Monitoring`
- Platform: windows
