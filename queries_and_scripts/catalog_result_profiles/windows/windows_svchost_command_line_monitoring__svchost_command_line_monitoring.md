# Svchost Command Line Monitoring

## Catalog Identity

- Catalog ID: `windows_svchost_command_line_monitoring`
- Catalog name: `Svchost Command Line Monitoring`
- Platform: windows
