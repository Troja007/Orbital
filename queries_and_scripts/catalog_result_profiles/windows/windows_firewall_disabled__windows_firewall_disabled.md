...
- Catalog ID: `windows_firewall_disabled`
- Catalog name: `Windows Firewall Disabled`
- Platform: windows
...
| Label | Columns |
| --- | --- |
| `windows_firewall_disabled` | `reg_key`, `path`, `name`, `data`, `datetime(mtime, "unixepoch")` |

Label row counts:
- `windows_firewall_disabled`: 9
