# User Access Control Restrictions Disabled

## Catalog Identity

- Catalog ID: `uac_remote_restrictions_disabled`
- Catalog name: `User Access Control Restrictions Disabled`
- Platform: windows
