# RDP Registry Port Configuration Monitoring

## Catalog Identity

- Catalog ID: `registry_rdp_port_monitoring`
- Catalog name: `RDP Registry Port Configuration Monitoring`
- Platform: windows
