# Windows Registry Remote Desktop Protocol Saved Connections

## Catalog Identity

- Catalog ID: `windows_registry_rdp_saved_connections`
- Catalog name: `Windows Registry Remote Desktop Protocol Saved Connections`
- Platform: windows
...
- Returned labels:
- `windows_registry_rdp_saved_connections`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_registry_rdp_saved_connections` | `remote_host`, `username_hint` |

Label row counts:
- `windows_registry_rdp_saved_connections`: 1
