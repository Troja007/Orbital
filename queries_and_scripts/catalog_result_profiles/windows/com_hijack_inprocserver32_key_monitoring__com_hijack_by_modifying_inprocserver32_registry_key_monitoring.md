# COM Hijack By Modifying InprocServer32 Registry Key Monitoring

## Catalog Identity

- Catalog ID: `com_hijack_inprocserver32_key_monitoring`
- Catalog name: `COM Hijack By Modifying InprocServer32 Registry Key Monitoring`
- Platform: windows
...
| Label | Columns |
| --- | --- |
| `com_hijack_inprocserver32_key_monitoring` | `reg_path`, `name`, `type`, `data` |

Label row counts:
- `com_hijack_inprocserver32_key_monitoring`: 21

## How To Read The Result

Observed validation result:

The endpoint answered and returned 21 rows in the validation run.
