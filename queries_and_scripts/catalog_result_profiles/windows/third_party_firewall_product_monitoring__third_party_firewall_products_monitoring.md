# Third Party Firewall Products Monitoring

## Catalog Identity

- Catalog ID: `third_party_firewall_product_monitoring`
- Catalog name: `Third Party Firewall Products Monitoring`
- Platform: windows
...
- Returned labels:
- `third_party_firewall_product_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `third_party_firewall_product_monitoring` | `displayName`, `Path To Signed Executable`, `Path To Signed Reporting Executable` |

Label row counts:
- `third_party_firewall_product_monitoring`: 1
...
Catalog warnings:
- Products must be properly registered with Windows to be present in this table.
