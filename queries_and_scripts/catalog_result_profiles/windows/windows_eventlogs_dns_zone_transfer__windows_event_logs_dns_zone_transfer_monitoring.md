# Windows Event Logs: DNS Zone Transfer Monitoring

## Catalog Identity

- Catalog ID: `windows_eventlogs_dns_zone_transfer`
- Catalog name: `Windows Event Logs: DNS Zone Transfer Monitoring`
- Platform: windows
