# Windows Security Features Monitoring

## Catalog Identity

- Catalog ID: `windows_security_features_monitoring`
- Catalog name: `Windows Security Features Monitoring`
- Platform: windows
...
- Returned labels:
- `windows_security_features_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_security_features_monitoring` | `firewall`, `autoupdate`, `antivirus`, `antispyware`, `internet_settings`, `windows_security_center_service`, `user_account_control` |

Label row counts:
- `windows_security_features_monitoring`: 1
