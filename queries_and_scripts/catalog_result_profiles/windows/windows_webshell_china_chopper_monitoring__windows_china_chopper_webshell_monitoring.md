# Windows China Chopper Webshell Monitoring

## Catalog Identity

- Catalog ID: `windows_webshell_china_chopper_monitoring`
- Catalog name: `Windows China Chopper Webshell Monitoring`
- Platform: windows
