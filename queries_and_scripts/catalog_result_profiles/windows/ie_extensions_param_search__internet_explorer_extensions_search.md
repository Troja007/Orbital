# Internet Explorer Extensions Search

## Catalog Identity

- Catalog ID: `ie_extensions_param_search`
- Catalog name: `Internet Explorer Extensions Search`
- Platform: windows
...
- Returned labels:
- `internet_explorer_extensions_search`

Observed columns:

| Label | Columns |
| --- | --- |
| `internet_explorer_extensions_search` | `name`, `registry_path`, `version`, `path` |

Label row counts:
- `internet_explorer_extensions_search`: 11
