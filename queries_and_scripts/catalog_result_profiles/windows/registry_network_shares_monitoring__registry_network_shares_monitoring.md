# Registry Network Shares Monitoring

## Catalog Identity

- Catalog ID: `registry_network_shares_monitoring`
- Catalog name: `Registry Network Shares Monitoring`
- Platform: windows
