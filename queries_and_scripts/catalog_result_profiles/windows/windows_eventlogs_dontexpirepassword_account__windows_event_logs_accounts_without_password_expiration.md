# Windows Event Logs: Accounts Without Password Expiration

## Catalog Identity

- Catalog ID: `windows_eventlogs_dontexpirepassword_account`
- Catalog name: `Windows Event Logs: Accounts Without Password Expiration`
- Platform: windows
