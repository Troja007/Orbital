# Powershell GetForegroundWindow Detected

## Catalog Identity

- Catalog ID: `powershell_getforegroundwindow`
- Catalog name: `Powershell GetForegroundWindow Detected`
- Platform: windows
