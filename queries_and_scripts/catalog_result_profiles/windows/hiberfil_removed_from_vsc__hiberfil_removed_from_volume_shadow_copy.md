# Hiberfil Removed From Volume Shadow Copy

## Catalog Identity

- Catalog ID: `hiberfil_removed_from_vsc`
- Catalog name: `Hiberfil Removed From Volume Shadow Copy`
- Platform: windows
