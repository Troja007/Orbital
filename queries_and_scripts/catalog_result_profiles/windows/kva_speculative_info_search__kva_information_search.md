# KVA Information Search

## Catalog Identity

- Catalog ID: `kva_speculative_info_search`
- Catalog name: `KVA Information Search`
- Platform: windows
...
- Returned labels:
- `kva_information_search`

Observed columns:

| Label | Columns |
| --- | --- |
| `kva_information_search` | `kva_shadow_enabled`, `kva_shadow_user_global`, `kva_shadow_pcid`, `kva_shadow_inv_pcid`, `bp_mitigations`, `bp_system_pol_disabled`, `bp_microcode_disabled`, `cpu_spec_ctrl_supported`, `ibrs_support_enabled`, `stibp_support_enabled`, `cpu_pred_cmd_supported` |

Label row counts:
- `kva_information_search`: 1
