# Windows Protocol Handlers Monitoring

## Catalog Identity

- Catalog ID: `windows_protocol_handlers_monitoring`
- Catalog name: `Windows Protocol Handlers Monitoring`
- Platform: windows
...
- Returned labels:
- `windows_protocol_handlers_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_protocol_handlers_monitoring` | `protocol_dll`, `sha256` |

Label row counts:
- `windows_protocol_handlers_monitoring`: 6
