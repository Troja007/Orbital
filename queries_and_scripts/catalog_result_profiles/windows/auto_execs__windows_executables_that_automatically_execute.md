# Windows executables that automatically execute

## Catalog Identity

- Catalog ID: `auto_execs`
- Catalog name: `Windows executables that automatically execute`
- Platform: windows
...
The endpoint answered and returned 1000 rows in the validation run.
...
Catalog warnings:
- Due to SHA256 hashing, this query can take some time in returning results.
