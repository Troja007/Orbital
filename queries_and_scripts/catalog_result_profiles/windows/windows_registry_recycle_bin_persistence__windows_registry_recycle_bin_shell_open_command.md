# Windows Registry Recycle Bin Shell Open Command

## Catalog Identity

- Catalog ID: `windows_registry_recycle_bin_persistence`
- Catalog name: `Windows Registry Recycle Bin Shell Open Command`
- Platform: windows
