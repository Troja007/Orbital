# Windows LOLBins Execution

## Catalog Identity

- Catalog ID: `windows_lolbins_execution_detection`
- Catalog name: `Windows LOLBins Execution`
- Platform: windows
