# Winsock Parameters Monitoring

## Catalog Identity

- Catalog ID: `winsock_parameters_modified`
- Catalog name: `Winsock Parameters Monitoring`
- Platform: windows
...
| Label | Columns |
| --- | --- |
| `winsock_parameters` | `reg_key`, `path`, `name`, `data`, `last_modified` |

Label row counts:
- `winsock_parameters`: 50

## How To Read The Result

Observed validation result:

The endpoint answered and returned 50 rows in the validation run.
