# Registry Key BootExecute Monitoring

## Catalog Identity

- Catalog ID: `registry_persistence_bootexecute`
- Catalog name: `Registry Key BootExecute Monitoring`
- Platform: windows
...
- Returned labels:
- `registry_key_bootexecute`

Observed columns:

| Label | Columns |
| --- | --- |
| `registry_key_bootexecute` | `reg_key`, `path`, `name`, `data`, `last_modified` |

Label row counts:
- `registry_key_bootexecute`: 2
