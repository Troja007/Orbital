# Process Parent Monitoring

## Catalog Identity

- Catalog ID: `process_parent_parameterized_search`
- Catalog name: `Process Parent Monitoring`
...
| Label | Columns |
| --- | --- |
| `process_parent` | `pid`, `name`, `path`, `cmdline`, `cwd`, `uid`, `gid`, `on_disk`, `total_size` |
