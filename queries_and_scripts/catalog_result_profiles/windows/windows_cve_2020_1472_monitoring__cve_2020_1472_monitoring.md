# CVE-2020-1472 Monitoring

## Catalog Identity

- Catalog ID: `windows_cve_2020_1472_monitoring`
- Catalog name: `CVE-2020-1472 Monitoring`
- Platform: windows
...
- Returned labels:
- `windows_cve_2020_1472_registry`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_cve_2020_1472_registry` | `key`, `name`, `data`, `last_modified`, `CVE-2020-1472 Status` |

Label row counts:
- `windows_cve_2020_1472_registry`: 1
