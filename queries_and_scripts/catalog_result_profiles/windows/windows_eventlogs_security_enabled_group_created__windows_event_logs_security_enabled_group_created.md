# Windows Event Logs Security Enabled Group Created

## Catalog Identity

- Catalog ID: `windows_eventlogs_security_enabled_group_created`
- Catalog name: `Windows Event Logs Security Enabled Group Created`
- Platform: windows
