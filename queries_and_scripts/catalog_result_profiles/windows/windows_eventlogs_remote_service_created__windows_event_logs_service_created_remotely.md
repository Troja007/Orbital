# Windows Event Logs Service Created Remotely

## Catalog Identity

- Catalog ID: `windows_eventlogs_remote_service_created`
- Catalog name: `Windows Event Logs Service Created Remotely`
- Platform: windows
