# Windows Event Logs For Account Access Removal Monitoring

## Catalog Identity

- Catalog ID: `event_logs_account_access_removal_monitoring`
- Catalog name: `Windows Event Logs For Account Access Removal Monitoring`
- Platform: windows
