# Windows CVE-2022-30190 Registry Mitigations

## Catalog Identity

- Catalog ID: `windows_registry_follina_temp_mitigation`
- Catalog name: `Windows CVE-2022-30190 Registry Mitigations`
- Platform: windows
...
- Returned labels:
- `windows_registry_follina_mitigation_msdt_protocol`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_registry_follina_mitigation_msdt_protocol` | `path`, `name`, `data`, `last_modified` |

Label row counts:
- `windows_registry_follina_mitigation_msdt_protocol`: 4

## How To Read The Result

Observed validation result:

The endpoint answered and returned 4 rows in the validation run.
