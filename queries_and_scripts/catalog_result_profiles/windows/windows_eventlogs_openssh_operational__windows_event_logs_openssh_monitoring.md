# Windows Event Logs: OpenSSH Monitoring

## Catalog Identity

- Catalog ID: `windows_eventlogs_openssh_operational`
- Catalog name: `Windows Event Logs: OpenSSH Monitoring`
- Platform: windows
