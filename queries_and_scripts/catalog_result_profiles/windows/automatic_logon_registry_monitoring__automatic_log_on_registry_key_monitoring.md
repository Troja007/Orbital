# Automatic Log On Registry Key Monitoring

## Catalog Identity

- Catalog ID: `automatic_logon_registry_monitoring`
- Catalog name: `Automatic Log On Registry Key Monitoring`
- Platform: windows
...
- Returned labels:
- `automatic_logon_registry_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `automatic_logon_registry_monitoring` | `last_modified`, `reg_path`, `name`, `data` |

Label row counts:
- `automatic_logon_registry_monitoring`: 1
