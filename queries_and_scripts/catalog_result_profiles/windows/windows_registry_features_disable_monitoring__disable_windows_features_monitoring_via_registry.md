# Disable Windows Features Monitoring via Registry

## Catalog Identity

- Catalog ID: `windows_registry_features_disable_monitoring`
- Catalog name: `Disable Windows Features Monitoring via Registry`
- Platform: windows
