# Windows Event Logs: Permission Change on Organizational Unit by Computer

## Catalog Identity

- Catalog ID: `windows_eventlogs_permission_change_on_ou_by_computer`
- Catalog name: `Windows Event Logs: Permission Change on Organizational Unit by Computer`
- Platform: windows
