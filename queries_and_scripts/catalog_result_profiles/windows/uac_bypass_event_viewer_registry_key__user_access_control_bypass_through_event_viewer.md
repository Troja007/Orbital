# User Access Control Bypass Through Event Viewer

## Catalog Identity

- Catalog ID: `uac_bypass_event_viewer_registry_key`
- Catalog name: `User Access Control Bypass Through Event Viewer`
- Platform: windows
