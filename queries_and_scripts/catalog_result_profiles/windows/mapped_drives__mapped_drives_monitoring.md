# Mapped Drives Monitoring

## Catalog Identity

- Catalog ID: `mapped_drives`
- Catalog name: `Mapped Drives Monitoring`
- Platform: windows
...
Catalog warnings:
- This query does not show smb shares connected without mapping to a drive
