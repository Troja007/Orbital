# Windows Event Logs: SPN Set on User Account

## Catalog Identity

- Catalog ID: `windows_eventlogs_spn_set_on_user_account`
- Catalog name: `Windows Event Logs: SPN Set on User Account`
- Platform: windows
