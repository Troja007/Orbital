# Registry Key DisablePasswordChange Monitoring

## Catalog Identity

- Catalog ID: `windows_password_change_disabled`
- Catalog name: `Registry Key DisablePasswordChange Monitoring`
- Platform: windows
