# CVE-2020-0796 Monitoring

## Catalog Identity

- Catalog ID: `cve_2020_0796_monitoring`
- Catalog name: `CVE-2020-0796 Monitoring`
- Platform: windows
...
- Returned labels:
- `cve_2020_0796_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `cve_2020_0796_monitoring` | `SMBv3 CVE-2020-0796` |

Label row counts:
- `cve_2020_0796_monitoring`: 1
