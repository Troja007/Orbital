# Windows Events For Backup of DPAPI Key Monitoring

## Catalog Identity

- Catalog ID: `windows_events_backup_of_backup_key_monitoring`
- Catalog name: `Windows Events For Backup of DPAPI Key Monitoring`
- Platform: windows
