# Windows Disk Info Monitoring

## Catalog Identity

- Catalog ID: `windows_disk_info_monitoring`
- Catalog name: `Windows Disk Info Monitoring`
- Platform: windows
...
- Returned labels:
- `windows_disk_info_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_disk_info_monitoring` | `partitions`, `disk_index`, `type`, `id`, `pnp_device_id`, `disk_size`, `manufacturer`, `hardware_model`, `name`, `serial`, `description` |

Label row counts:
- `windows_disk_info_monitoring`: 1
