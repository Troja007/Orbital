# Backup/Restore Registry Monitoring

## Catalog Identity

- Catalog ID: `registry_backup_restore_monitoring`
- Catalog name: `Backup/Restore Registry Monitoring`
- Platform: windows
...
- Returned labels:
- `registry_backup_restore_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `registry_backup_restore_monitoring` | `reg_key`, `path`, `name`, `data`, `last_modified` |

Label row counts:
- `registry_backup_restore_monitoring`: 8
