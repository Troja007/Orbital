# WDigest Protocol Monitoring

## Catalog Identity

- Catalog ID: `windows_wdigest_monitoring`
- Catalog name: `WDigest Protocol Monitoring`
- Platform: windows
