# Winlogon Shell Registry Monitoring

## Catalog Identity

- Catalog ID: `winlogon_shell_registry_key`
- Catalog name: `Winlogon Shell Registry Monitoring`
- Platform: windows
...
- Returned labels:
- `winlogon_shell_registry`

Observed columns:

| Label | Columns |
| --- | --- |
| `winlogon_shell_registry` | `reg_key`, `path`, `name`, `data`, `datetime(mtime, "unixepoch")` |

Label row counts:
- `winlogon_shell_registry`: 1
