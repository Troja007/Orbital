# COM Hijacking via TreatAs Monitoring

## Catalog Identity

- Catalog ID: `windows_com_hijacking_via_treatas_monitoring`
- Catalog name: `COM Hijacking via TreatAs Monitoring`
- Platform: windows
