...
- Catalog ID: `user_groups_search`
- Catalog name: `Users Group Search`
...
| Label | Columns |
| --- | --- |
| `users_group_search` | `uid`, `username`, `groupname`, `group_sid`, `comment` |

Label row counts:
- `users_group_search`: 6
