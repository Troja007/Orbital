# Windows Event Logs: Kerberos Ticket with Low Encryption

## Catalog Identity

- Catalog ID: `windows_eventlogs_kerberos_ticket_low_encryption`
- Catalog name: `Windows Event Logs: Kerberos Ticket with Low Encryption`
- Platform: windows
