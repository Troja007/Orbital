# Windows Logon Scripts Monitoring

## Catalog Identity

- Catalog ID: `logon_scripts_monitoring`
- Catalog name: `Windows Logon Scripts Monitoring`
- Platform: windows
