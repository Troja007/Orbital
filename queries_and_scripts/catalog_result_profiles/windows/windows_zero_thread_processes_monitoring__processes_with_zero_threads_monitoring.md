# Processes With Zero Threads Monitoring

## Catalog Identity

- Catalog ID: `windows_zero_thread_processes_monitoring`
- Catalog name: `Processes With Zero Threads Monitoring`
- Platform: windows
