# Windows OpenSSL Vulnerable Versions Monitoring

## Catalog Identity

- Catalog ID: `windows_openssl_vulnerabilities_monitoring`
- Catalog name: `Windows OpenSSL Vulnerable Versions Monitoring`
- Platform: windows
