# Shell Folders Registry Key Monitoring

## Catalog Identity

- Catalog ID: `registry_shell_folders_monitoring`
- Catalog name: `Shell Folders Registry Key Monitoring`
- Platform: windows
...
- Observed row count: 44
- Row-count bucket: `medium_11_100`
- Returned labels:
- `shell_folders_registry_key`

Observed columns:

| Label | Columns |
| --- | --- |
| `shell_folders_registry_key` | `reg_key`, `path`, `name`, `data`, `last_modified` |

Label row counts:
- `shell_folders_registry_key`: 44

## How To Read The Result

Observed validation result:

The endpoint answered and returned 44 rows in the validation run.
