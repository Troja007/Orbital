# User Account Settings Monitoring

## Catalog Identity

- Catalog ID: `user_account_settings_monitoring`
- Catalog name: `User Account Settings Monitoring`
- Platform: windows
...
- Returned labels:
- `user_account_settings_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `user_account_settings_monitoring` | `User_name`, `SID`, `Disabled`, `Domain`, `LocalAccount`, `Lockout`, `PasswordChangeable`, `PasswordExpires`, `PasswordRequired` |

Label row counts:
- `user_account_settings_monitoring`: 16

## How To Read The Result

Observed validation result:

The endpoint answered and returned 16 rows in the validation run.
