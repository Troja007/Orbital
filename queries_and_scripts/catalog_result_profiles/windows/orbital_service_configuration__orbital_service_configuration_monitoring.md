# Orbital Service Configuration Monitoring

## Catalog Identity

- Catalog ID: `orbital_service_configuration`
- Catalog name: `Orbital Service Configuration Monitoring`
- Platform: windows
...
- Returned labels:
- `orbital_service_configuration`

Observed columns:

| Label | Columns |
| --- | --- |
| `orbital_service_configuration` | `name`, `service_type`, `display_name`, `status`, `pid`, `start_type`, `path`, `module_path`, `user_account` |

Label row counts:
- `orbital_service_configuration`: 1
