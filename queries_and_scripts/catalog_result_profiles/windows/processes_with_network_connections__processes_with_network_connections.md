...
- Catalog ID: `processes_with_network_connections`
- Catalog name: `Processes With Network Connections`
...
Label row counts:
- `processes_with_network_connections`: 5
