# Registry File Size Monitoring

## Catalog Identity

- Catalog ID: `registry_file_size_monitoring`
- Catalog name: `Registry File Size Monitoring`
- Platform: windows
...
- Returned labels:
- `registry_file_size_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `registry_file_size_monitoring` | `CurrentSize`, `MaximumSize`, `ProposedSize`, `Status`, `PercentageUsed` |

Label row counts:
- `registry_file_size_monitoring`: 1
