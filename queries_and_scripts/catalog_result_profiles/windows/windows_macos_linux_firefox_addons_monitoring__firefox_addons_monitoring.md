# Firefox Addons Monitoring

## Catalog Identity

- Catalog ID: `windows_macos_linux_firefox_addons_monitoring`
- Catalog name: `Firefox Addons Monitoring`
...
- Returned labels:
- `windows_macos_linux_firefox_addons_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_macos_linux_firefox_addons_monitoring` | `username`, `name`, `identifier`, `creator`, `type`, `version`, `description`, `source_url`, `visible`, `active`, `disabled`, `autoupdate`, `native`, `location`, `path` |

Label row counts:
- `windows_macos_linux_firefox_addons_monitoring`: 34

## How To Read The Result

Observed validation result:

The endpoint answered and returned 34 rows in the validation run.
