# Windows Event Logs New Accounts Creation/Removal Monitoring

## Catalog Identity

- Catalog ID: `windows_eventlogs_account_creation_removal_monitoring`
- Catalog name: `Windows Event Logs New Accounts Creation/Removal Monitoring`
- Platform: windows
