# Powershell Events Monitoring

## Catalog Identity

- Catalog ID: `powershell_events_monitoring`
- Catalog name: `Powershell Events Monitoring`
- Platform: windows
...
| Label | Columns |
| --- | --- |
| `powershell_events` | `script_name`, `script_path`, `script_text`, `script_block_id`, `script_block_count` |

Label row counts:
- `powershell_events`: 104

## How To Read The Result

Observed validation result:

The endpoint answered and returned 104 rows in the validation run.
...
Catalog warnings:
- This query requires PowerShell Script Block Logging enabled.
- This query could produce a large volume of results.
