# Registry Computer Name Modifications Monitoring

## Catalog Identity

- Catalog ID: `registry_computername_modifications_monitoring`
- Catalog name: `Registry Computer Name Modifications Monitoring`
- Platform: windows
...
- Returned labels:
- `registry_computer_name_modifications`

Observed columns:

| Label | Columns |
| --- | --- |
| `registry_computer_name_modifications` | `reg_key`, `path`, `name`, `data`, `last_modified` |

Label row counts:
- `registry_computer_name_modifications`: 3
