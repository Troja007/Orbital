# Running Services Search

## Catalog Identity

- Catalog ID: `running_services_search`
- Catalog name: `Running Services Search`
- Platform: windows
