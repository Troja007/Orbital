# Windows Registry MS Office Settings

## Catalog Identity

- Catalog ID: `windows_registry_office_settings`
- Catalog name: `Windows Registry MS Office Settings`
- Platform: windows
