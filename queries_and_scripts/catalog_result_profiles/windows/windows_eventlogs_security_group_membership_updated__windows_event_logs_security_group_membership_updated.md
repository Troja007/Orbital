# Windows Event Logs Security Group Membership Updated

## Catalog Identity

- Catalog ID: `windows_eventlogs_security_group_membership_updated`
- Catalog name: `Windows Event Logs Security Group Membership Updated`
- Platform: windows
