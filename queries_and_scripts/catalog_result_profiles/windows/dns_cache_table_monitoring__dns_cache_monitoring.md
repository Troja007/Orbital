...
- Catalog ID: `dns_cache_table_monitoring`
- Catalog name: `DNS Cache Monitoring`
- Platform: windows
...
Label row counts:
- `dns_cache_table_monitoring`: 83

## How To Read The Result

Observed validation result:

The endpoint answered and returned 83 rows in the validation run.
