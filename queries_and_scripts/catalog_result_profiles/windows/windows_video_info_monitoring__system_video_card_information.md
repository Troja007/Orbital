# System Video Card Information

## Catalog Identity

- Catalog ID: `windows_video_info_monitoring`
- Catalog name: `System Video Card Information`
- Platform: windows
...
- Returned labels:
- `windows_video_info_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_video_info_monitoring` | `color_depth`, `driver`, `driver_date`, `driver_version`, `manufacturer`, `model`, `series`, `video_mode` |

Label row counts:
- `windows_video_info_monitoring`: 1
