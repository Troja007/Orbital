# Windows Recycle Bin Files Monitoring

## Catalog Identity

- Catalog ID: `windows_file_recycle_bin`
- Catalog name: `Windows Recycle Bin Files Monitoring`
- Platform: windows
...
- Observed row count: 5
- Row-count bucket: `low_1_10`
- Returned labels:
- `windows_file_recycle_bin`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_file_recycle_bin` | `filename`, `path`, `uid`, `gid`, `last_access_time`, `last_modification_time`, `last_status_change_time`, `create_time`, `hard_links`, `symlink`, `type`, `size`, `volume_serial` |

Label row counts:
- `windows_file_recycle_bin`: 5

## How To Read The Result

Observed validation result:

The endpoint answered and returned 5 rows in the validation run.
