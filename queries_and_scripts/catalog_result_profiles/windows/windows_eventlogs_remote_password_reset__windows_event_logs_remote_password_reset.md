# Windows Event Logs: Remote Password Reset

## Catalog Identity

- Catalog ID: `windows_eventlogs_remote_password_reset`
- Catalog name: `Windows Event Logs: Remote Password Reset`
- Platform: windows
