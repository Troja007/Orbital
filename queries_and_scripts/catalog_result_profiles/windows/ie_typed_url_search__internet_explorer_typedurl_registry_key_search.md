# Internet Explorer TypedURL Registry Key Search

## Catalog Identity

- Catalog ID: `ie_typed_url_search`
- Catalog name: `Internet Explorer TypedURL Registry Key Search`
- Platform: windows
...
| Label | Columns |
| --- | --- |
| `ie_typed_url_search` | `data`, `last_modified` |

Label row counts:
- `ie_typed_url_search`: 3
