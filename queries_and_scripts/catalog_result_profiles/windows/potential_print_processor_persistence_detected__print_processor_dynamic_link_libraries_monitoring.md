# Print Processor Dynamic Link Libraries Monitoring

## Catalog Identity

- Catalog ID: `potential_print_processor_persistence_detected`
- Catalog name: `Print Processor Dynamic Link Libraries Monitoring`
- Platform: windows
...
- Observed row count: 3
- Row-count bucket: `low_1_10`
- Returned labels:
- `print_processors_file_data`
- `registered_print_processors`

Observed columns:

| Label | Columns |
| --- | --- |
| `print_processors_file_data` | `path`, `directory`, `filename`, `sha256`, `last_accessed`, `last_modified`, `created` |
| `registered_print_processors` | `reg_key`, `name`, `data`, `last_modified` |

Label row counts:
- `print_processors_file_data`: 1
- `registered_print_processors`: 2

## How To Read The Result

Observed validation result:

The endpoint answered and returned 3 rows in the validation run.
