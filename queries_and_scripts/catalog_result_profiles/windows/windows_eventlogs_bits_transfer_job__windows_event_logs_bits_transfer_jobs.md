# Windows Event Logs BITS Transfer Jobs

## Catalog Identity

- Catalog ID: `windows_eventlogs_bits_transfer_job`
- Catalog name: `Windows Event Logs BITS Transfer Jobs`
- Platform: windows
...
- Observed row count: 166
- Row-count bucket: `high_101_1000`
- Returned labels:
- `windows_eventlogs_bits_transfer_job`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_eventlogs_bits_transfer_job` | `datetime`, `bits_job_name`, `url`, `data`, `pid`, `name`, `cmdline`, `uid`, `username` |

Label row counts:
- `windows_eventlogs_bits_transfer_job`: 166

## How To Read The Result

Observed validation result:

The endpoint answered and returned 166 rows in the validation run.
