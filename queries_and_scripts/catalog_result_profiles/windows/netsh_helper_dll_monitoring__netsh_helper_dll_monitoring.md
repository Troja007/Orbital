# Netsh Helper DLL Monitoring

## Catalog Identity

- Catalog ID: `netsh_helper_dll_monitoring`
- Catalog name: `Netsh Helper DLL Monitoring`
- Platform: windows
...
- Observed row count: 20
- Row-count bucket: `medium_11_100`
- Returned labels:
- `netsh_helper_dll_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `netsh_helper_dll_monitoring` | `reg_key`, `path`, `name`, `data`, `last_modified` |

Label row counts:
- `netsh_helper_dll_monitoring`: 20

## How To Read The Result

Observed validation result:

The endpoint answered and returned 20 rows in the validation run.
