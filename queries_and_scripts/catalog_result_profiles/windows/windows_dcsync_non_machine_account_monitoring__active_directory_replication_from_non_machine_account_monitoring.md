# Active Directory Replication from Non Machine Account Monitoring

## Catalog Identity

- Catalog ID: `windows_dcsync_non_machine_account_monitoring`
- Catalog name: `Active Directory Replication from Non Machine Account Monitoring`
- Platform: windows
