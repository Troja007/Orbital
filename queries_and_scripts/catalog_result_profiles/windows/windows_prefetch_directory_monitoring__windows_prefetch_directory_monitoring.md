# Windows Prefetch Directory Monitoring

## Catalog Identity

- Catalog ID: `windows_prefetch_directory_monitoring`
- Catalog name: `Windows Prefetch Directory Monitoring`
- Platform: windows
...
| Label | Columns |
| --- | --- |
| `windows_prefetch_directory` | `filename`, `path`, `sha256`, `uid`, `gid`, `last_access_time`, `last_modification_time`, `last_status_change_time`, `create_time`, `hard_links`, `symlink`, `type`, `attributes`, `volume_serial`, `file_id` |

Label row counts:
- `windows_prefetch_directory`: 238

## How To Read The Result

Observed validation result:

The endpoint answered and returned 238 rows in the validation run.
