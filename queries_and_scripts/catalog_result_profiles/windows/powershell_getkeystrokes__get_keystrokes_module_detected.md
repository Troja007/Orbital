# Get-Keystrokes Module Detected

## Catalog Identity

- Catalog ID: `Powershell_GetKeystrokes`
- Catalog name: `Get-Keystrokes Module Detected`
- Platform: windows
