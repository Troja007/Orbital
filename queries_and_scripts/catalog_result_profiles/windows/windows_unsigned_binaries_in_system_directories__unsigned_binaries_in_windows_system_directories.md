# Unsigned Binaries in Windows System Directories

## Catalog Identity

- Catalog ID: `windows_unsigned_binaries_in_system_directories`
- Catalog name: `Unsigned Binaries in Windows System Directories`
- Platform: windows
...
- Returned labels:
- `windows_unsigned_binaries_in_system_directories`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_unsigned_binaries_in_system_directories` | `path` |

Label row counts:
- `windows_unsigned_binaries_in_system_directories`: 8
