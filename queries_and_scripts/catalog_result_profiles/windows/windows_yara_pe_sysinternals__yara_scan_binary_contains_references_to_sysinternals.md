# YARA Scan: Binary Contains References to SysInternals

## Catalog Identity

- Catalog ID: `windows_yara_pe_sysinternals`
- Catalog name: `YARA Scan: Binary Contains References to SysInternals`
- Platform: windows
