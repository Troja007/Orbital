# Windows Remote Management Allows Unencrypted Traffic

## Catalog Identity

- Catalog ID: `winrm_allows_unencrypted_traffic`
- Catalog name: `Windows Remote Management Allows Unencrypted Traffic`
- Platform: windows
...
- Returned labels:
- `winrm_registry_configuration`

Observed columns:

| Label | Columns |
| --- | --- |
| `winrm_registry_configuration` | `reg_key`, `path`, `name`, `data`, `last_modified` |

Label row counts:
- `winrm_registry_configuration`: 9
