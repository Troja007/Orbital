# PsExec Windows Event Logs Monitoring

## Catalog Identity

- Catalog ID: `psexec_windows_event_logs_monitoring`
- Catalog name: `PsExec Windows Event Logs Monitoring`
- Platform: windows
...
- Returned labels:
- `psexec_windows_event_logs_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `psexec_windows_event_logs_monitoring` | `TimeGenerated`, `Message`, `EventIdentifier`, `SourceName`, `Logfile`, `TimeWritten`, `Type` |

Label row counts:
- `psexec_windows_event_logs_monitoring`: 1
