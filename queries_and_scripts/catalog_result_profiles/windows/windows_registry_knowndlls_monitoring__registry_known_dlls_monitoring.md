# Registry Known DLLs Monitoring

## Catalog Identity

- Catalog ID: `windows_registry_knowndlls_monitoring`
- Catalog name: `Registry Known DLLs Monitoring`
- Platform: windows
...
- Observed row count: 32
- Row-count bucket: `medium_11_100`
- Returned labels:
- `windows_registry_knowndlls_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_registry_knowndlls_monitoring` | `data`, `last_modified` |

Label row counts:
- `windows_registry_knowndlls_monitoring`: 32

## How To Read The Result

Observed validation result:

The endpoint answered and returned 32 rows in the validation run.
