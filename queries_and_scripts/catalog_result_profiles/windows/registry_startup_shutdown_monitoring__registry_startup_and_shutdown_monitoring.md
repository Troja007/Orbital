# Registry Startup And Shutdown Monitoring

## Catalog Identity

- Catalog ID: `registry_startup_shutdown_monitoring`
- Catalog name: `Registry Startup And Shutdown Monitoring`
- Platform: windows
