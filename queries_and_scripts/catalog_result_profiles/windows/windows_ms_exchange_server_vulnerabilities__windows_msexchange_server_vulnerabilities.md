# Windows MSExchange Server Vulnerabilities

## Catalog Identity

- Catalog ID: `windows_ms_exchange_server_vulnerabilities`
- Catalog name: `Windows MSExchange Server Vulnerabilities`
- Platform: windows
...
Catalog warnings:
- This query can take some time to load the results due to YARA scans.
