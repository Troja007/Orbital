# Virtual Network Computing Services Monitoring

## Catalog Identity

- Catalog ID: `vnc_installed_or_running_monitoring`
- Catalog name: `Virtual Network Computing Services Monitoring`
- Platform: windows
