# Windows Events for Remote Launch Permissions Denied Monitoring

## Catalog Identity

- Catalog ID: `windows_dcom_remote_launch_permission_denied_monitoring`
- Catalog name: `Windows Events for Remote Launch Permissions Denied Monitoring`
- Platform: windows
