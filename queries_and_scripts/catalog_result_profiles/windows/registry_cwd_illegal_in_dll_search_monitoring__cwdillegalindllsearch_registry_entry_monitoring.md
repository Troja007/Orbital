# CWDIllegalInDllSearch Registry Entry Monitoring

## Catalog Identity

- Catalog ID: `registry_cwd_illegal_in_dll_search_monitoring`
- Catalog name: `CWDIllegalInDllSearch Registry Entry Monitoring`
- Platform: windows
