# Domain or Kerberos Policy Changes Monitoring

## Catalog Identity

- Catalog ID: `windows_domain_kerberos_policy_changes_monitoring`
- Catalog name: `Domain or Kerberos Policy Changes Monitoring`
- Platform: windows
