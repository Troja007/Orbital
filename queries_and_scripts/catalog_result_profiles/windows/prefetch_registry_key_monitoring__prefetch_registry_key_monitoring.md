# Prefetch Registry Key Monitoring

## Catalog Identity

- Catalog ID: `prefetch_registry_key_monitoring`
- Catalog name: `Prefetch Registry Key Monitoring`
- Platform: windows
...
- Returned labels:
- `prefetch_registry_key`

Observed columns:

| Label | Columns |
| --- | --- |
| `prefetch_registry_key` | `reg_key`, `path`, `name`, `data`, `last_modified` |

Label row counts:
- `prefetch_registry_key`: 10
