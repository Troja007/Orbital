...
- Catalog ID: `kernel_information`
- Catalog name: `Kernel Information Monitoring`
...
| Label | Columns |
| --- | --- |
| `kernel_information` | `version`, `arguments`, `path`, `device`, `sha256` |

Label row counts:
- `kernel_information`: 1
