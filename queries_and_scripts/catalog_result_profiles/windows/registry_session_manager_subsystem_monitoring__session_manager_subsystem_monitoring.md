# Session Manager SubSystem Monitoring

## Catalog Identity

- Catalog ID: `registry_session_manager_subsystem_monitoring`
- Catalog name: `Session Manager SubSystem Monitoring`
- Platform: windows
...
- Returned labels:
- `registry_session_manager_subsystem_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `registry_session_manager_subsystem_monitoring` | `key`, `path`, `name`, `type`, `data`, `datetime(mtime, "unixepoch")` |

Label row counts:
- `registry_session_manager_subsystem_monitoring`: 1
