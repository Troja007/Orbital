# Windows Time Providers Monitoring

## Catalog Identity

- Catalog ID: `windows_time_providers_monitoring`
- Catalog name: `Windows Time Providers Monitoring`
- Platform: windows
...
- Returned labels:
- `windows_time_providers_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_time_providers_monitoring` | `reg_key`, `path`, `name`, `data`, `last_modified`, `sha256` |

Label row counts:
- `windows_time_providers_monitoring`: 3
