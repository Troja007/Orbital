# Windows IE Browser Extensions Monitoring

## Catalog Identity

- Catalog ID: `windows_ie_browser_extensions`
- Catalog name: `Windows IE Browser Extensions Monitoring`
- Platform: windows
...
- Returned labels:
- `windows_ie_browser_extensions`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_ie_browser_extensions` | `name`, `registry_path`, `version`, `path` |

Label row counts:
- `windows_ie_browser_extensions`: 11
