# Modify Service To Run PowerShell Monitoring

## Catalog Identity

- Catalog ID: `service_binpath_being_set_to_powershell`
- Catalog name: `Modify Service To Run PowerShell Monitoring`
- Platform: windows
