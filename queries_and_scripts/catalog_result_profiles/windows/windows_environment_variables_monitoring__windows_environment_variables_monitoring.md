...
- Catalog ID: `windows_environment_variables_monitoring`
- Catalog name: `Windows Environment Variables Monitoring`
- Platform: windows
...
The endpoint answered and returned 37 rows in the validation run.
