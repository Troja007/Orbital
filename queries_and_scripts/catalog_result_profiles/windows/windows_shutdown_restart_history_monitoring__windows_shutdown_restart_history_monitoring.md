# Windows Shutdown/Restart History Monitoring

## Catalog Identity

- Catalog ID: `windows_shutdown_restart_history_monitoring`
- Catalog name: `Windows Shutdown/Restart History Monitoring`
- Platform: windows
...
- Observed row count: 79
- Row-count bucket: `medium_11_100`
- Returned labels:
- `windows_shutdown_restart_history_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_shutdown_restart_history_monitoring` | `datetime`, `Event` |

Label row counts:
- `windows_shutdown_restart_history_monitoring`: 79

## How To Read The Result

Observed validation result:

The endpoint answered and returned 79 rows in the validation run.
...
Catalog warnings:
- This query retrieve data from Windows Event Log. If Event Log service has been disabled or data cleared, then this query will not show any results.
