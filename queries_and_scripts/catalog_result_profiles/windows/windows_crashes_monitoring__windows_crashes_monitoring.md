# Windows Crashes Monitoring

## Catalog Identity

- Catalog ID: `windows_crashes_monitoring`
- Catalog name: `Windows Crashes Monitoring`
- Platform: windows
