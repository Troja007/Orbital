# Windows Events Audit Log was Cleared

## Catalog Identity

- Catalog ID: `windows_eventlogs_audit_log_cleared`
- Catalog name: `Windows Events Audit Log was Cleared`
- Platform: windows
