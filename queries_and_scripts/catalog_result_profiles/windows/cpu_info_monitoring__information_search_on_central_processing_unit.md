# Information Search on Central Processing Unit

## Catalog Identity

- Catalog ID: `cpu_info_monitoring`
- Catalog name: `Information Search on Central Processing Unit`
- Platform: windows
...
- Returned labels:
- `information_search_on_central_processing_unit`

Observed columns:

| Label | Columns |
| --- | --- |
| `information_search_on_central_processing_unit` | `device_id`, `model`, `manufacturer`, `processor_type`, `availability`, `cpu_status`, `number_of_cores`, `logical_processors`, `current_clock_speed`, `max_clock_speed` |

Label row counts:
- `information_search_on_central_processing_unit`: 2
