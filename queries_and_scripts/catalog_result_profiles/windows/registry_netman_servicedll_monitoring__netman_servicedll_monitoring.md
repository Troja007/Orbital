# Netman ServiceDLL Monitoring

## Catalog Identity

- Catalog ID: `registry_netman_servicedll_monitoring`
- Catalog name: `Netman ServiceDLL Monitoring`
- Platform: windows
...
| Label | Columns |
| --- | --- |
| `netman_servicedll` | `reg_key`, `path`, `name`, `data`, `last_modified` |
