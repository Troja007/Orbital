# Microsoft Office Macros Registry Keys Monitoring

## Catalog Identity

- Catalog ID: `registry_office_security_monitoring`
- Catalog name: `Microsoft Office Macros Registry Keys Monitoring`
- Platform: windows
