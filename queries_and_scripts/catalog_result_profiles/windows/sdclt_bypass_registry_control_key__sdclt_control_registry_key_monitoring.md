# SDCLT Control Registry Key Monitoring

## Catalog Identity

- Catalog ID: `sdclt_bypass_registry_control_key`
- Catalog name: `SDCLT Control Registry Key Monitoring`
- Platform: windows
