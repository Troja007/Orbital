# Unquoted Service Paths Monitoring

## Catalog Identity

- Catalog ID: `unquoted_service_paths_monitoring`
- Catalog name: `Unquoted Service Paths Monitoring`
- Platform: windows
