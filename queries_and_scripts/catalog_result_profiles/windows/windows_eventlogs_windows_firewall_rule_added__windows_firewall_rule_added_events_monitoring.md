# Windows Firewall Rule Added Events Monitoring

## Catalog Identity

- Catalog ID: `windows_eventlogs_windows_firewall_rule_added`
- Catalog name: `Windows Firewall Rule Added Events Monitoring`
- Platform: windows
