# Windows Office Default Templates Monitoring

## Catalog Identity

- Catalog ID: `windows_office_default_templates_monitoring`
- Catalog name: `Windows Office Default Templates Monitoring`
- Platform: windows
