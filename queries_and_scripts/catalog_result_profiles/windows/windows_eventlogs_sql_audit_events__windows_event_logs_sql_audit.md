# Windows Event Logs SQL Audit

## Catalog Identity

- Catalog ID: `windows_eventlogs_sql_audit_events`
- Catalog name: `Windows Event Logs SQL Audit`
- Platform: windows
