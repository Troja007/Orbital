# Windows Event Logs Account Lockout Monitoring

## Catalog Identity

- Catalog ID: `windows_eventlogs_account_lockout_monitoring`
- Catalog name: `Windows Event Logs Account Lockout Monitoring`
- Platform: windows
