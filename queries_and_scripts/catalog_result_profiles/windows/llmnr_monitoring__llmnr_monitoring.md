...
- Catalog ID: `llmnr_monitoring`
- Catalog name: `LLMNR Monitoring`
- Platform: windows
...
- Observed row count: 69
- Row-count bucket: `medium_11_100`
- Returned labels:
- `hosts_with_llmnt_traffic`
- `llmnr_windows_events`

Observed columns:

| Label | Columns |
| --- | --- |
| `hosts_with_llmnt_traffic` | `name`, `address`, `port` |
| `llmnr_windows_events` | `TimeGenerated`, `Message`, `EventIdentifier`, `Logfile`, `SourceName`, `Type`, `TimeWritten` |

Label row counts:
- `hosts_with_llmnt_traffic`: 1
- `llmnr_windows_events`: 68

## How To Read The Result

Observed validation result:

The endpoint answered and returned 69 rows in the validation run.
