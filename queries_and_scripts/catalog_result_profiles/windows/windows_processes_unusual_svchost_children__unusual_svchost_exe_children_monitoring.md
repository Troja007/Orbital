# Unusual Svchost.exe Children Monitoring

## Catalog Identity

- Catalog ID: `windows_processes_unusual_svchost_children`
- Catalog name: `Unusual Svchost.exe Children Monitoring`
- Platform: windows
