# Windows Event Logs Network Objects Access Monitoring

## Catalog Identity

- Catalog ID: `windows_eventlogs_network_access_monitoring`
- Catalog name: `Windows Event Logs Network Objects Access Monitoring`
- Platform: windows
