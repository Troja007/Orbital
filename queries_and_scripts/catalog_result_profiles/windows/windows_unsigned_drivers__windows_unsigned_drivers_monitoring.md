# Windows Unsigned Drivers Monitoring

## Catalog Identity

- Catalog ID: `windows_unsigned_drivers`
- Catalog name: `Windows Unsigned Drivers Monitoring`
- Platform: windows
...
- Returned labels:
- `windows_unsigned_drivers`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_unsigned_drivers` | `device_id`, `device_name`, `image`, `service`, `service_key`, `driver_key`, `datetime(date, "unixepoch")` |

Label row counts:
- `windows_unsigned_drivers`: 1
