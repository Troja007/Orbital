# Safe DLL Search Disabled

## Catalog Identity

- Catalog ID: `registry_safe_dll_search_monitoring`
- Catalog name: `Safe DLL Search Disabled`
- Platform: windows
...
- Validation status: `completed_direct_verification`
