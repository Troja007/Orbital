# Running Services Search by Path

## Catalog Identity

- Catalog ID: `running_services_search_by_path`
- Catalog name: `Running Services Search by Path`
- Platform: windows
- Profile type: sanitized catalog result profile
- Source run: 2026-06-15/2026-06-16
- Catalog updated: 2025-01-01T17:51:59.150055646Z
...
- Observed row count: 681
- Row-count bucket: `high_101_1000`
- Returned labels:
- `running_services_search`

Observed columns:

| Label | Columns |
| --- | --- |
| `running_services_search` | `name`, `service_type`, `display_name`, `status`, `pid`, `start_type`, `win32_exit_code`, `service_exit_code`, `path`, `module_path`, `description`, `user_account` |

Label row counts:
- `running_services_search`: 681

## How To Read The Result

Observed validation result:

The endpoint answered and returned 681 rows in the validation run.
