# Disabled Registry Tools Monitoring

## Catalog Identity

- Catalog ID: `registry_tools_access_monitoring`
- Catalog name: `Disabled Registry Tools Monitoring`
- Platform: windows
