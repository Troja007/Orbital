...
- Catalog ID: `cpuid_features_monitoring`
- Catalog name: `CPU Feature Search`
...
| Label | Columns |
| --- | --- |
| `cpu_feature_search` | `feature`, `value` |

Label row counts:
- `cpu_feature_search`: 69
...
Catalog warnings:
- This query may produce excessive amounts of CPU data. Changing parameters to a specific set of relevant features is advised.
