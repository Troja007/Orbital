# System Route Table Monitoring

## Catalog Identity

- Catalog ID: `routes_table_monitoring`
- Catalog name: `System Route Table Monitoring`
...
| Label | Columns |
| --- | --- |
| `routes_table` | `destination`, `netmask`, `gateway`, `source`, `flags`, `interface`, `mtu`, `metric`, `type` |
