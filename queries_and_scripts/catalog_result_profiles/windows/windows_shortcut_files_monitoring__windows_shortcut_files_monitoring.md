# Windows Shortcut Files Monitoring

## Catalog Identity

- Catalog ID: `windows_shortcut_files_monitoring`
- Catalog name: `Windows Shortcut Files Monitoring`
- Platform: windows
...
- Observed row count: 280
- Row-count bucket: `high_101_1000`
- Returned labels:
- `windows_shortcut_files_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_shortcut_files_monitoring` | `Caption`, `FileName`, `Path`, `Target`, `CreationDate`, `sha256`, `Status`, `Extension`, `Archive`, `Compressed`, `Encrypted`, `EncryptionMethod`, `Hidden` |

Label row counts:
- `windows_shortcut_files_monitoring`: 280

## How To Read The Result

Observed validation result:

The endpoint answered and returned 280 rows in the validation run.
