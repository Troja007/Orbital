# Winlogon Registry Key Monitoring

## Catalog Identity

- Catalog ID: `registry_persistence_winlogon`
- Catalog name: `Winlogon Registry Key Monitoring`
- Platform: windows
...
| Label | Columns |
| --- | --- |
| `winlogon_registry_key` | `reg_key`, `path`, `name`, `data`, `last_modified` |

Label row counts:
- `winlogon_registry_key`: 4
