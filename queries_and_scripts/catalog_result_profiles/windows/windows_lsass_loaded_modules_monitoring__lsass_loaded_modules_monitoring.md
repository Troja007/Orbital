# Lsass Loaded Modules Monitoring

## Catalog Identity

- Catalog ID: `windows_lsass_loaded_modules_monitoring`
- Catalog name: `Lsass Loaded Modules Monitoring`
- Platform: windows
...
- Observed row count: 109
- Row-count bucket: `high_101_1000`
- Returned labels:
- `windows_lsass_loaded_modules_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_lsass_loaded_modules_monitoring` | `path`, `original_program_name`, `serial_number`, `issuer_name`, `subject_name`, `result`, `sha256` |

Label row counts:
- `windows_lsass_loaded_modules_monitoring`: 109

## How To Read The Result

Observed validation result:

The endpoint answered and returned 109 rows in the validation run.
