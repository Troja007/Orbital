# Windows Open Shares Monitoring

## Catalog Identity

- Catalog ID: `windows_open_shares_monitoring`
- Catalog name: `Windows Open Shares Monitoring`
- Platform: windows
...
| Label | Columns |
| --- | --- |
| `windows_open_shares` | `description`, `install_date`, `status`, `allow_maximum`, `maximum_allowed`, `name`, `path`, `type` |

Label row counts:
- `windows_open_shares`: 4
