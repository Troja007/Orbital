# Monitoring DLLs Used By Running Processes

## Catalog Identity

- Catalog ID: `system_process_dll_monitoring`
- Catalog name: `Monitoring DLLs Used By Running Processes`
- Platform: windows
...
- Observed row count: 128
- Row-count bucket: `high_101_1000`
- Returned labels:
- `monitoring_dlls_used_by_running_processes`

Observed columns:

| Label | Columns |
| --- | --- |
| `monitoring_dlls_used_by_running_processes` | `process_name`, `dll_name` |

Label row counts:
- `monitoring_dlls_used_by_running_processes`: 128

## How To Read The Result

Observed validation result:

The endpoint answered and returned 128 rows in the validation run.
