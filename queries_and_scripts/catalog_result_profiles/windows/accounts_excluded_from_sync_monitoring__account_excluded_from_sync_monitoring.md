# Account Excluded From Sync Monitoring

## Catalog Identity

- Catalog ID: `accounts_excluded_from_sync_monitoring`
- Catalog name: `Account Excluded From Sync Monitoring`
- Platform: windows
