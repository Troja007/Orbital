# Windows AppCertDLLs Monitoring

## Catalog Identity

- Catalog ID: `windows_appcertdlls_registry_monitoring`
- Catalog name: `Windows AppCertDLLs Monitoring`
- Platform: windows
