...
- Catalog ID: `registry_last_logged_on_user_monitoring`
- Catalog name: `Last Logged On User Monitoring`
- Platform: windows
...
- Returned labels:
- `registry_last_logged_on_user_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `registry_last_logged_on_user_monitoring` | `name`, `data`, `last_modified` |

Label row counts:
- `registry_last_logged_on_user_monitoring`: 1
