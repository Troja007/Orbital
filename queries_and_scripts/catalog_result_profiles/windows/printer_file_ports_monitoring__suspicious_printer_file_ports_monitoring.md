# Suspicious Printer File Ports Monitoring

## Catalog Identity

- Catalog ID: `printer_file_ports_monitoring`
- Catalog name: `Suspicious Printer File Ports Monitoring`
- Platform: windows
