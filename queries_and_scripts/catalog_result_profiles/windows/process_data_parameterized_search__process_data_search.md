...
- Catalog ID: `process_data_parameterized_search`
- Catalog name: `Process Data Search`
...
| Label | Columns |
| --- | --- |
| `process_data` | `pid`, `name`, `path`, `cmdline`, `cwd`, `uid`, `gid`, `on_disk`, `total_size`, `parent`, `threads`, `sha256` |
...
The endpoint answered and returned 154 rows in the validation run.
