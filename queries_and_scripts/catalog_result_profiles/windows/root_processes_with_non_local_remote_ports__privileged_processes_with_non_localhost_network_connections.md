# Privileged Processes With Non-localhost Network Connections

## Catalog Identity

- Catalog ID: `root_processes_with_non_local_remote_ports`
- Catalog name: `Privileged Processes With Non-localhost Network Connections`
