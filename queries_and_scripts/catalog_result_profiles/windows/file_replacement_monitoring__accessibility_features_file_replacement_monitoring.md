# Accessibility Features File Replacement Monitoring

## Catalog Identity

- Catalog ID: `file_replacement_monitoring`
- Catalog name: `Accessibility Features File Replacement Monitoring`
- Platform: windows
