# DCSync Granted to Standard User Monitoring

## Catalog Identity

- Catalog ID: `windows_dcsync_granted_to_standard_user_monitoring`
- Catalog name: `DCSync Granted to Standard User Monitoring`
- Platform: windows
