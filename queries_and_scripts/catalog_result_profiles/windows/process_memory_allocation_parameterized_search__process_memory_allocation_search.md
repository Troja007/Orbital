# Process Memory Allocation Search

## Catalog Identity

- Catalog ID: `process_memory_allocation_parameterized_search`
- Catalog name: `Process Memory Allocation Search`
...
- Returned labels:
- `process_memory_allocation_search`

Observed columns:

| Label | Columns |
| --- | --- |
| `process_memory_allocation_search` | `name`, `path`, `wired_size`, `resident_size`, `total_size`, `start`, `end`, `permissions` |

Label row counts:
- `process_memory_allocation_search`: 2

## How To Read The Result

Observed validation result:

The endpoint answered and returned 2 rows in the validation run.
