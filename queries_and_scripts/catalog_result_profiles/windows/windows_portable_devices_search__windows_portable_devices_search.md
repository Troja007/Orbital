# Windows Portable Devices Search

## Catalog Identity

- Catalog ID: `windows_portable_devices_search`
- Catalog name: `Windows Portable Devices Search`
- Platform: windows
