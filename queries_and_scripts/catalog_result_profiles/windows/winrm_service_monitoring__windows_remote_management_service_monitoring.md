# Windows Remote Management Service Monitoring

## Catalog Identity

- Catalog ID: `winrm_service_monitoring`
- Catalog name: `Windows Remote Management Service Monitoring`
- Platform: windows
...
- Returned labels:
- `winrm_service_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `winrm_service_monitoring` | `name`, `display_name`, `status`, `pid`, `start_type`, `path`, `module_path`, `user_account` |

Label row counts:
- `winrm_service_monitoring`: 1
