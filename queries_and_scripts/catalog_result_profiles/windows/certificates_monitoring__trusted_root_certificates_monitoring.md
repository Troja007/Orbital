# Trusted Root Certificates Monitoring

## Catalog Identity

- Catalog ID: `certificates_monitoring`
- Catalog name: `Trusted Root Certificates Monitoring`
- Platform: windows
...
| Label | Columns |
| --- | --- |
| `certificates` | `common_name`, `issuer`, `serial`, `expiration_date` |
...
The endpoint answered and returned 42 rows in the validation run.
