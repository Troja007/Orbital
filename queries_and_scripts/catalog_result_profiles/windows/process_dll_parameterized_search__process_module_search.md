# Process Module Search

## Catalog Identity

- Catalog ID: `process_dll_parameterized_search`
- Catalog name: `Process Module Search`
...
- Observed row count: 4784
- Row-count bucket: `very_high_over_1000`
- Returned labels:
- `process_module_search`

Observed columns:

| Label | Columns |
| --- | --- |
| `process_module_search` | `process_name`, `process_loaded_module` |

Label row counts:
- `process_module_search`: 4784

## How To Read The Result

Observed validation result:

The endpoint answered and returned 4784 rows in the validation run.
