# Platform Information Search

## Catalog Identity

- Catalog ID: `platform_info_search`
- Catalog name: `Platform Information Search`
...
| Label | Columns |
| --- | --- |
| `platform_information` | `vendor`, `version`, `date`, `revision`, `address`, `size`, `volume_size`, `extra` |
