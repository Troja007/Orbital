# Windows Event Logs for LSASS Dump Monitoring

## Catalog Identity

- Catalog ID: `windows_eventlogs_lsass_dump_monitoring`
- Catalog name: `Windows Event Logs for LSASS Dump Monitoring`
- Platform: windows
