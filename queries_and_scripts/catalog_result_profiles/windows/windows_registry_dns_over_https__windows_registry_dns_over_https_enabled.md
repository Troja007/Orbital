# Windows Registry DNS Over HTTPS Enabled

## Catalog Identity

- Catalog ID: `windows_registry_dns_over_https`
- Catalog name: `Windows Registry DNS Over HTTPS Enabled`
- Platform: windows
