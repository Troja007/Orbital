# Scheduled Tasks Executed Regsvr32.exe

## Catalog Identity

- Catalog ID: `windows_scheduled_tasks_regsvr32_execution`
- Catalog name: `Scheduled Tasks Executed Regsvr32.exe`
- Platform: windows
