# Event Log Files Configuration Monitoring

## Catalog Identity

- Catalog ID: `event_log_files_configuration_monitoring`
- Catalog name: `Event Log Files Configuration Monitoring`
- Platform: windows
...
- Observed row count: 13
- Row-count bucket: `medium_11_100`
- Returned labels:
- `event_log_files_configuration_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `event_log_files_configuration_monitoring` | `FileName`, `Archive`, `Compressed`, `Encrypted`, `Hidden`, `FileSize`, `MaxFileSize`, `Creation_Date`, `Last_Accessed`, `Last_Modified`, `NumberOfRecords`, `OverwriteOutDated`, `OverWritePolicy`, `Sources`, `Status` |

Label row counts:
- `event_log_files_configuration_monitoring`: 13

## How To Read The Result

Observed validation result:

The endpoint answered and returned 13 rows in the validation run.
