# Windows Event Logs Operation on Active Directory Object was Performed

## Catalog Identity

- Catalog ID: `windows_eventlogs_ad_object_access_monitoring`
- Catalog name: `Windows Event Logs Operation on Active Directory Object was Performed`
- Platform: windows
...
- Observed row count: 165
- Row-count bucket: `high_101_1000`
- Returned labels:
- `windows_eventlogs_ad_object_access_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_eventlogs_ad_object_access_monitoring` | `datetime`, `subject_user_name`, `subject_domain_name`, `object_server`, `object_type`, `object_name`, `operation_type`, `data` |

Label row counts:
- `windows_eventlogs_ad_object_access_monitoring`: 165

## How To Read The Result

Observed validation result:

The endpoint answered and returned 165 rows in the validation run.
