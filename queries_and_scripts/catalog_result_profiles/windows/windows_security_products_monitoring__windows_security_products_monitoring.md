# Windows Security Products Monitoring

## Catalog Identity

- Catalog ID: `windows_security_products_monitoring`
- Catalog name: `Windows Security Products Monitoring`
- Platform: windows
...
- Returned labels:
- `windows_security_products_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_security_products_monitoring` | `name`, `type`, `state`, `state_timestamp`, `remediation_path`, `signatures_up_to_date` |

Label row counts:
- `windows_security_products_monitoring`: 1
