# PowerShell Event Auditing State Monitoring

## Catalog Identity

- Catalog ID: `powershell_event_auditing_state`
- Catalog name: `PowerShell Event Auditing State Monitoring`
- Platform: windows
...
- Returned labels:
- `powershell_event_auditing_state`

Observed columns:

| Label | Columns |
| --- | --- |
| `powershell_event_auditing_state` | `reg_key`, `path`, `name`, `data`, `last_modified` |

Label row counts:
- `powershell_event_auditing_state`: 4
