# Windows WLAN Events Monitoring

## Catalog Identity

- Catalog ID: `windows_wlan_events_monitoring`
- Catalog name: `Windows WLAN Events Monitoring`
- Platform: windows
