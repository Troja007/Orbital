# PowerShell History Monitoring

## Catalog Identity

- Catalog ID: `powershell_history_monitoring`
- Catalog name: `PowerShell History Monitoring`
- Platform: windows
...
The endpoint answered and returned 459 rows in the validation run.
