# Disabled Accounts Usage Monitoring

## Catalog Identity

- Catalog ID: `windows_events_disabled_account_usage_monitoring`
- Catalog name: `Disabled Accounts Usage Monitoring`
- Platform: windows
