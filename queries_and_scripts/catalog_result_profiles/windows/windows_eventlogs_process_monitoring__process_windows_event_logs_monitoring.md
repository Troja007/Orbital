# Process Windows Event Logs Monitoring

## Catalog Identity

- Catalog ID: `windows_eventlogs_process_monitoring`
- Catalog name: `Process Windows Event Logs Monitoring`
- Platform: windows
...
- Observed row count: 72
- Row-count bucket: `medium_11_100`
- Returned labels:
- `windows_eventlogs_process_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_eventlogs_process_monitoring` | `datetime`, `new_process_name`, `parent_process_name`, `data` |

Label row counts:
- `windows_eventlogs_process_monitoring`: 72

## How To Read The Result

Observed validation result:

The endpoint answered and returned 72 rows in the validation run.
