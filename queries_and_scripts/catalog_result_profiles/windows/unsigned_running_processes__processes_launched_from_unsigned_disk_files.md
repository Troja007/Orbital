# Processes Launched From Unsigned Disk Files

## Catalog Identity

- Catalog ID: `unsigned_running_processes`
- Catalog name: `Processes Launched From Unsigned Disk Files`
- Platform: windows
...
- Returned labels:
- `processes_launched_from_unsigned_disk_files`

Observed columns:

| Label | Columns |
| --- | --- |
| `processes_launched_from_unsigned_disk_files` | `pid`, `path` |

Label row counts:
- `processes_launched_from_unsigned_disk_files`: 2
