# Orbital Installation Directory Monitoring

## Catalog Identity

- Catalog ID: `orbital_installation_directory_monitoring`
- Catalog name: `Orbital Installation Directory Monitoring`
- Platform: windows
