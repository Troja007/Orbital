# Shim Cache Monitoring

## Catalog Identity

- Catalog ID: `windows_shimcache_monitoring`
- Catalog name: `Shim Cache Monitoring`
- Platform: windows
...
| Label | Columns |
| --- | --- |
| `windows_shimcache_monitoring` | `entry`, `path`, `file_modified_time`, `sha256` |
...
The endpoint answered and returned 1024 rows in the validation run.
