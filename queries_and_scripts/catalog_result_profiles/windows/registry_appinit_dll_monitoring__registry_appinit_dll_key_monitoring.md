# Registry AppInit_Dll Key Monitoring

## Catalog Identity

- Catalog ID: `registry_appinit_dll_monitoring`
- Catalog name: `Registry AppInit_Dll Key Monitoring`
- Platform: windows
...
- Returned labels:
- `registry_appinit_dll_key`

Observed columns:

| Label | Columns |
| --- | --- |
| `registry_appinit_dll_key` | `reg_key`, `path`, `name`, `data`, `last_modified` |

Label row counts:
- `registry_appinit_dll_key`: 2
