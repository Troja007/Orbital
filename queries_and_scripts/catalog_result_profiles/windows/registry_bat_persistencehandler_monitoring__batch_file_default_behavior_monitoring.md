# Batch File Default Behavior Monitoring

## Catalog Identity

- Catalog ID: `registry_bat_persistencehandler_monitoring`
- Catalog name: `Batch File Default Behavior Monitoring`
- Platform: windows
