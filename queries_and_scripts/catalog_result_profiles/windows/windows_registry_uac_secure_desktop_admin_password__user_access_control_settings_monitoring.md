# User Access Control Settings Monitoring

## Catalog Identity

- Catalog ID: `windows_registry_uac_secure_desktop_admin_password`
- Catalog name: `User Access Control Settings Monitoring`
- Platform: windows
...
- Returned labels:
- `windows_registry_uac_secure_desktop_admin_password`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_registry_uac_secure_desktop_admin_password` | `path`, `name`, `data`, `last_modified` |

Label row counts:
- `windows_registry_uac_secure_desktop_admin_password`: 3
