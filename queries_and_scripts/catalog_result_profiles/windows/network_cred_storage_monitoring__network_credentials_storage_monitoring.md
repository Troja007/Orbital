# Network Credentials Storage Monitoring

## Catalog Identity

- Catalog ID: `network_cred_storage_monitoring`
- Catalog name: `Network Credentials Storage Monitoring`
- Platform: windows
