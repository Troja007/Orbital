...
- Catalog ID: `process_mutex_parameterized_search`
- Catalog name: `Process Mutex Search`
- Platform: windows
...
- Observed row count: 363
- Row-count bucket: `high_101_1000`
- Returned labels:
- `process_mutex_search`

Observed columns:

| Label | Columns |
| --- | --- |
| `process_mutex_search` | `object_name` |

Label row counts:
- `process_mutex_search`: 363

## How To Read The Result

Observed validation result:

The endpoint answered and returned 363 rows in the validation run.
