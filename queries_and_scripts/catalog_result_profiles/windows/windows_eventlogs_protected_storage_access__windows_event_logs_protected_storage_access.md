# Windows Event Logs Protected Storage Access

## Catalog Identity

- Catalog ID: `windows_eventlogs_protected_storage_access`
- Catalog name: `Windows Event Logs Protected Storage Access`
- Platform: windows
