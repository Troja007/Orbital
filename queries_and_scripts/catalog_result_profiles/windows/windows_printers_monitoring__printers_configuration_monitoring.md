# Printers Configuration Monitoring

## Catalog Identity

- Catalog ID: `windows_printers_monitoring`
- Catalog name: `Printers Configuration Monitoring`
- Platform: windows
...
- Returned labels:
- `windows_printers_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_printers_monitoring` | `Name`, `Direct`, `DoCompleteFirst`, `KeepPrintedJobs`, `Local`, `Network`, `PortName`, `PrintJobDataType`, `PrintProcessor`, `Priority`, `Queued`, `RawOnly`, `Shared`, `WorkOffline`, `PrinterPaperNames`, `CapabilityDescriptions` |

Label row counts:
- `windows_printers_monitoring`: 3
