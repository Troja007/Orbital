# Registry DeleteFlags For Services Monitoring

## Catalog Identity

- Catalog ID: `registry_services_delete_flags_monitoring`
- Catalog name: `Registry DeleteFlags For Services Monitoring`
- Platform: windows
...
- Returned labels:
- `registry_deleteflags_for_services`

Observed columns:

| Label | Columns |
| --- | --- |
| `registry_deleteflags_for_services` | `reg_key`, `path`, `name`, `data`, `last_modified` |

Label row counts:
- `registry_deleteflags_for_services`: 4
