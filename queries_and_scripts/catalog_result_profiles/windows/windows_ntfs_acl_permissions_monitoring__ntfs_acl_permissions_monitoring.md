# NTFS ACL Permissions Monitoring

## Catalog Identity

- Catalog ID: `windows_ntfs_acl_permissions_monitoring`
- Catalog name: `NTFS ACL Permissions Monitoring`
- Platform: windows
...
- Returned labels:
- `windows_ntfs_acl_permissions_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_ntfs_acl_permissions_monitoring` | `path`, `type`, `principal`, `access`, `inherited_from` |

Label row counts:
- `windows_ntfs_acl_permissions_monitoring`: 4
