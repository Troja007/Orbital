...
- Catalog ID: `hidden_scheduled_tasks_monitoring`
- Catalog name: `Hidden Scheduled Tasks Monitoring`
- Platform: windows
...
- Returned labels:
- `hidden_scheduled_tasks_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `hidden_scheduled_tasks_monitoring` | `name`, `action`, `path`, `enabled`, `state`, `last_run_time`, `next_run_time`, `last_run_code` |

Label row counts:
- `hidden_scheduled_tasks_monitoring`: 9
