# Registry Service Paths Monitoring

## Catalog Identity

- Catalog ID: `registry_service_paths_monitoring`
- Catalog name: `Registry Service Paths Monitoring`
- Platform: windows
...
- Returned labels:
- `registry_service_paths_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `registry_service_paths_monitoring` | `reg_key`, `path`, `name`, `data`, `last_modified` |

Label row counts:
- `registry_service_paths_monitoring`: 3
