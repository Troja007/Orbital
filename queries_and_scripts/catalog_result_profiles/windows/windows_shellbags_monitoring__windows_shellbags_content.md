# Windows ShellBags Content

## Catalog Identity

- Catalog ID: `windows_shellbags_monitoring`
- Catalog name: `Windows ShellBags Content`
- Platform: windows
...
The endpoint answered and returned 87 rows in the validation run.
