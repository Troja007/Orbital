# Check File Code Signing Status

## Catalog Identity

- Catalog ID: `valid_certificate_param_search`
- Catalog name: `Check File Code Signing Status`
- Platform: windows
...
- Observed row count: 4443
- Row-count bucket: `very_high_over_1000`
- Returned labels:
- `check_file_code_signing_status`

Observed columns:

| Label | Columns |
| --- | --- |
| `check_file_code_signing_status` | `path`, `original_program_name`, `serial_number`, `issuer_name`, `subject_name`, `result` |

Label row counts:
- `check_file_code_signing_status`: 4443

## How To Read The Result

Observed validation result:

The endpoint answered and returned 4443 rows in the validation run.
