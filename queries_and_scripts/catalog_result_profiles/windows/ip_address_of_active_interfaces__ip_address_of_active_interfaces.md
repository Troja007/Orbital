# IP Address of Active Interfaces

## Catalog Identity

- Catalog ID: `ip_address_of_active_interfaces`
- Catalog name: `IP Address of Active Interfaces`
...
- Returned labels:
- `ip_address_of_active_interfaces`

Observed columns:

| Label | Columns |
| --- | --- |
| `ip_address_of_active_interfaces` | `address`, `interface` |

Label row counts:
- `ip_address_of_active_interfaces`: 1
