# Windows Events For Account Modifications Monitoring

## Catalog Identity

- Catalog ID: `account_events_monitoring`
- Catalog name: `Windows Events For Account Modifications Monitoring`
- Platform: windows
