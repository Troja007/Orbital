# Networks Host Connected

## Catalog Identity

- Catalog ID: `connected_networks_history_monitoring`
- Catalog name: `Networks Host Connected`
- Platform: windows
...
| Label | Columns |
| --- | --- |
| `connected_networks_history_monitoring` | `reg_key`, `path`, `name`, `data`, `last_modified` |
