# Windows Registry Adobe Acrobat Settings

## Catalog Identity

- Catalog ID: `windows_registry_acrobat_reader_settings`
- Catalog name: `Windows Registry Adobe Acrobat Settings`
- Platform: windows
