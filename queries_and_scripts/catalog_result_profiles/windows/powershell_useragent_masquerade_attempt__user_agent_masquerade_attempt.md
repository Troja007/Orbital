# User Agent Masquerade Attempt

## Catalog Identity

- Catalog ID: `powershell_useragent_masquerade_attempt`
- Catalog name: `User Agent Masquerade Attempt`
- Platform: windows
