# Windows Management Instrumentation Suspicious Scripts Monitoring

## Catalog Identity

- Catalog ID: `wmi_suspicious_scripts_monitoring`
- Catalog name: `Windows Management Instrumentation Suspicious Scripts Monitoring`
- Platform: windows
