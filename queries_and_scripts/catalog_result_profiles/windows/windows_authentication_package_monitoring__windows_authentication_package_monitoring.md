# Windows Authentication Package Monitoring

## Catalog Identity

- Catalog ID: `windows_authentication_package_monitoring`
- Catalog name: `Windows Authentication Package Monitoring`
- Platform: windows
...
- Returned labels:
- `windows_authentication_package_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_authentication_package_monitoring` | `reg_key`, `path`, `name`, `data`, `last_modified` |

Label row counts:
- `windows_authentication_package_monitoring`: 1
