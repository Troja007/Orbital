# Screensaver Settings Monitoring

## Catalog Identity

- Catalog ID: `screensaver_settings_monitoring`
- Catalog name: `Screensaver Settings Monitoring`
- Platform: windows
...
- Returned labels:
- `screensaver_enabled_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `screensaver_enabled_monitoring` | `reg_key`, `path`, `name`, `data`, `last_modified` |

Label row counts:
- `screensaver_enabled_monitoring`: 3
