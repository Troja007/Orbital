...
- Catalog ID: `registry_parameterized_search`
- Catalog name: `Registry Key Search`
- Platform: windows
...
| Label | Columns |
| --- | --- |
| `registry_key_search` | `reg_key`, `path`, `name`, `data`, `last_modified` |

Label row counts:
- `registry_key_search`: 3797

## How To Read The Result

Observed validation result:

The endpoint answered and returned 3797 rows in the validation run.
