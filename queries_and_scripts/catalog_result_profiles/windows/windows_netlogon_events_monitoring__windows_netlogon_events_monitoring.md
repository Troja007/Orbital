# Windows Netlogon Events Monitoring

## Catalog Identity

- Catalog ID: `windows_netlogon_events_monitoring`
- Catalog name: `Windows Netlogon Events Monitoring`
- Platform: windows
