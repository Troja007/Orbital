# Unusual Conhost Parent Process

## Catalog Identity

- Catalog ID: `unusual_conhost_parent_process`
- Catalog name: `Unusual Conhost Parent Process`
- Platform: windows
...
- Returned labels:
- `unusual_conhost_parent_process`

Observed columns:

| Label | Columns |
| --- | --- |
| `unusual_conhost_parent_process` | `child_pid`, `child_name`, `parent_pid`, `parent_name` |

Label row counts:
- `unusual_conhost_parent_process`: 4
