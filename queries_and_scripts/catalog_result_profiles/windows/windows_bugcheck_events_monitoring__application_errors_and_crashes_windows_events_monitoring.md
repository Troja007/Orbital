# Application Errors and Crashes Windows Events Monitoring

## Catalog Identity

- Catalog ID: `windows_bugcheck_events_monitoring`
- Catalog name: `Application Errors and Crashes Windows Events Monitoring`
- Platform: windows
...
- Observed row count: 41
- Row-count bucket: `medium_11_100`
- Returned labels:
- `windows_bugcheck_events_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_bugcheck_events_monitoring` | `TimeGenerated`, `Message`, `EventIdentifier`, `Logfile`, `SourceName`, `Type`, `TimeWritten` |

Label row counts:
- `windows_bugcheck_events_monitoring`: 41

## How To Read The Result

Observed validation result:

The endpoint answered and returned 41 rows in the validation run.
