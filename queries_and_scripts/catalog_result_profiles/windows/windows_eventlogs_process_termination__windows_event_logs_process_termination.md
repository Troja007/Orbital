# Windows Event Logs Process Termination

## Catalog Identity

- Catalog ID: `windows_eventlogs_process_termination`
- Catalog name: `Windows Event Logs Process Termination`
- Platform: windows
