# Windows Defender Registry Configuration Monitoring

## Catalog Identity

- Catalog ID: `windows_defender_real_time_registry_configuration`
- Catalog name: `Windows Defender Registry Configuration Monitoring`
- Platform: windows
...
- Observed row count: 6
- Row-count bucket: `low_1_10`
- Returned labels:
- `windows_defender_real_time_registry_configuration`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_defender_real_time_registry_configuration` | `reg_key`, `path`, `name`, `data`, `last_modified` |

Label row counts:
- `windows_defender_real_time_registry_configuration`: 6

## How To Read The Result

Observed validation result:

The endpoint answered and returned 6 rows in the validation run.
