# Low Privilage File Associations

## Catalog Identity

- Catalog ID: `low_privilege_file_associations`
- Catalog name: `Low Privilage File Associations`
- Platform: windows
