# TCP Timestamp Registry Monitoring

## Catalog Identity

- Catalog ID: `tcp1323opts_registry_monitoring`
- Catalog name: `TCP Timestamp Registry Monitoring`
- Platform: windows
