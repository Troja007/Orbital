# RDP and SMB Connections Monitoring

## Catalog Identity

- Catalog ID: `rdp_smb_connections_monitoring`
- Catalog name: `RDP and SMB Connections Monitoring`
- Platform: windows
...
- Observed row count: 7
- Row-count bucket: `low_1_10`
- Returned labels:
- `rdp_smb_connections_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `rdp_smb_connections_monitoring` | `pid`, `name`, `username`, `local_address`, `local_port`, `remote_address`, `remote_port` |

Label row counts:
- `rdp_smb_connections_monitoring`: 7

## How To Read The Result

Observed validation result:

The endpoint answered and returned 7 rows in the validation run.
