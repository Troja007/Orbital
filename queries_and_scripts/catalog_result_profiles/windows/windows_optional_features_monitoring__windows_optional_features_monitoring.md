# Windows Optional Features Monitoring

## Catalog Identity

- Catalog ID: `windows_optional_features_monitoring`
- Catalog name: `Windows Optional Features Monitoring`
- Platform: windows
...
- Observed row count: 133
- Row-count bucket: `high_101_1000`
- Returned labels:
- `windows_optional_features_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_optional_features_monitoring` | `Caption`, `Name`, `FeatureStatus` |

Label row counts:
- `windows_optional_features_monitoring`: 133

## How To Read The Result

Observed validation result:

The endpoint answered and returned 133 rows in the validation run.
