# Windows Registry AppData Run Key Monitoring

## Catalog Identity

- Catalog ID: `windows_registry_appdata_run_key`
- Catalog name: `Windows Registry AppData Run Key Monitoring`
- Platform: windows
