# Windows Registry SIP Providers Monitoring

## Catalog Identity

- Catalog ID: `windows_registry_sip_providers`
- Catalog name: `Windows Registry SIP Providers Monitoring`
- Platform: windows
