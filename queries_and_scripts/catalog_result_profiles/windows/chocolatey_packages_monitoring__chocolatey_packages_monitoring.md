# Chocolatey Packages Monitoring

## Catalog Identity

- Catalog ID: `chocolatey_packages_monitoring`
- Catalog name: `Chocolatey Packages Monitoring`
- Platform: windows
