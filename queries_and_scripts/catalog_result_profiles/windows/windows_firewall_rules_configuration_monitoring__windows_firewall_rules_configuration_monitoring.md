# Windows Firewall Rules Configuration Monitoring

## Catalog Identity

- Catalog ID: `windows_firewall_rules_configuration_monitoring`
- Catalog name: `Windows Firewall Rules Configuration Monitoring`
- Platform: windows
...
- Observed row count: 609
- Row-count bucket: `high_101_1000`
- Returned labels:
- `windows_firewall_rules_configuration_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_firewall_rules_configuration_monitoring` | `Rule Name`, `Rule Logic`, `Last Updated` |

Label row counts:
- `windows_firewall_rules_configuration_monitoring`: 609

## How To Read The Result

Observed validation result:

The endpoint answered and returned 609 rows in the validation run.
