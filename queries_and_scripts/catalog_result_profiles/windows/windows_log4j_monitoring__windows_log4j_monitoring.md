# Windows Log4j Monitoring

## Catalog Identity

- Catalog ID: `windows_log4j_monitoring`
- Catalog name: `Windows Log4j Monitoring`
- Platform: windows
...
- Returned labels:
- `java_programs`
- `process_envars_classpath`

Observed columns:

| Label | Columns |
| --- | --- |
| `java_programs` | `name`, `version`, `install_location`, `install_source`, `install_date` |
| `process_envars_classpath` | `name`, `value` |

Label row counts:
- `java_programs`: 2
- `process_envars_classpath`: 1
...
Catalog warnings:
- This query can take some time to load the results due to YARA scan and file path collection. Limit the file path to speed up the query.
