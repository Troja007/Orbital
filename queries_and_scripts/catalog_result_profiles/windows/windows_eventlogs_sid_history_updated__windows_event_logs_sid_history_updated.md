# Windows Event Logs: SID History Updated

## Catalog Identity

- Catalog ID: `windows_eventlogs_sid_history_updated`
- Catalog name: `Windows Event Logs: SID History Updated`
- Platform: windows
