# Registry MS Office Accounts Monitoring

## Catalog Identity

- Catalog ID: `windows_registry_ms_office_accounts_monitoring`
- Catalog name: `Registry MS Office Accounts Monitoring`
- Platform: windows
