# Explorer.exe Default Location Monitoring

## Catalog Identity

- Catalog ID: `explorer_incorrect_location`
- Catalog name: `Explorer.exe Default Location Monitoring`
- Platform: windows
