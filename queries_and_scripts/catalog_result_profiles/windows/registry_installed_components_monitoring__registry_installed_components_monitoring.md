# Registry Installed Components Monitoring

## Catalog Identity

- Catalog ID: `registry_installed_components_monitoring`
- Catalog name: `Registry Installed Components Monitoring`
- Platform: windows
...
- Observed row count: 228
- Row-count bucket: `high_101_1000`
- Returned labels:
- `registry_installed_components_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `registry_installed_components_monitoring` | `reg_key`, `path`, `name`, `data`, `last_modified` |

Label row counts:
- `registry_installed_components_monitoring`: 228

## How To Read The Result

Observed validation result:

The endpoint answered and returned 228 rows in the validation run.
