...
- Catalog ID: `windows_eventlogs_driver_loaded`
- Catalog name: `Driver Loaded Windows Event Logs`
- Platform: windows
...
- Returned labels:
- `windows_eventlogs_driver_loaded`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_eventlogs_driver_loaded` | `datetime`, `image_path`, `data` |

Label row counts:
- `windows_eventlogs_driver_loaded`: 41
