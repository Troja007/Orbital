# Windows Event Logs NTDS Database Access

## Catalog Identity

- Catalog ID: `windows_eventlogs_ntds_database_access`
- Catalog name: `Windows Event Logs NTDS Database Access`
- Platform: windows
