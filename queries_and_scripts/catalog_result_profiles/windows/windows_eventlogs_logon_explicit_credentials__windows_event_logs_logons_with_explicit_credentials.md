# Windows Event Logs Logons with Explicit Credentials

## Catalog Identity

- Catalog ID: `windows_eventlogs_logon_explicit_credentials`
- Catalog name: `Windows Event Logs Logons with Explicit Credentials`
- Platform: windows
