# MS Office Trusted Documents Monitoring

## Catalog Identity

- Catalog ID: `windows_registry_msoffice_trusted_documents`
- Catalog name: `MS Office Trusted Documents Monitoring`
- Platform: windows
