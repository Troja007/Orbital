# Global Logger Event Tracing Session Disabled

## Catalog Identity

- Catalog ID: `global_logger_event_tracing_session_disabled`
- Catalog name: `Global Logger Event Tracing Session Disabled`
- Platform: windows
...
- Returned labels:
- `global_logger_event_tracing_session_disabled`

Observed columns:

| Label | Columns |
| --- | --- |
| `global_logger_event_tracing_session_disabled` | `reg_key`, `name`, `data`, `last_modified` |

Label row counts:
- `global_logger_event_tracing_session_disabled`: 8
