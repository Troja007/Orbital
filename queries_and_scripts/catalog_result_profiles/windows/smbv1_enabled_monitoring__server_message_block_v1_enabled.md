# Server Message Block v1 Enabled

## Catalog Identity

- Catalog ID: `smbv1_enabled_monitoring`
- Catalog name: `Server Message Block v1 Enabled`
- Platform: windows
