...
- Catalog ID: `windows_userassist_monitoring`
- Catalog name: `UserAssist Registry Data`
- Platform: windows
...
- Observed row count: 118
- Row-count bucket: `high_101_1000`
- Returned labels:
- `windows_userassist_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_userassist_monitoring` | `path`, `app_last_execution_time`, `count`, `sid` |

Label row counts:
- `windows_userassist_monitoring`: 118

## How To Read The Result

Observed validation result:

The endpoint answered and returned 118 rows in the validation run.
