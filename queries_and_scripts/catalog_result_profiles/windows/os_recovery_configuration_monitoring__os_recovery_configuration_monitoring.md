# OS Recovery Configuration Monitoring

## Catalog Identity

- Catalog ID: `os_recovery_configuration_monitoring`
- Catalog name: `OS Recovery Configuration Monitoring`
- Platform: windows
...
- Returned labels:
- `os_recovery_configuration_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `os_recovery_configuration_monitoring` | `AutoReboot`, `DebugFilePath`, `DebugInfoType`, `OverwriteExistingDebugFile`, `SendAdminAlert`, `WriteDebugInfo`, `WriteToSystemLog` |

Label row counts:
- `os_recovery_configuration_monitoring`: 1
