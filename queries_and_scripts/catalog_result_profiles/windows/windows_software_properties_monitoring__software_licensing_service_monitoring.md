# Software Licensing Service Monitoring

## Catalog Identity

- Catalog ID: `windows_software_properties_monitoring`
- Catalog name: `Software Licensing Service Monitoring`
- Platform: windows
...
- Returned labels:
- `windows_software_properties_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_software_properties_monitoring` | `OA3xOriginalProductKey`, `OA3xOriginalProductKeyDescription`, `Version` |

Label row counts:
- `windows_software_properties_monitoring`: 1
