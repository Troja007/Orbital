# Registry Context Menu Entries Monitoring

## Catalog Identity

- Catalog ID: `windows_registry_context_menu_entries`
- Catalog name: `Registry Context Menu Entries Monitoring`
- Platform: windows
...
- Returned labels:
- `windows_registry_context_menu_entries`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_registry_context_menu_entries` | `key`, `name`, `data`, `last_modified` |

Label row counts:
- `windows_registry_context_menu_entries`: 2
