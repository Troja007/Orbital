# Sysinternals Sysmon Configuration Monitoring

## Catalog Identity

- Catalog ID: `sysinternals_sysmon_config`
- Catalog name: `Sysinternals Sysmon Configuration Monitoring`
- Platform: windows
