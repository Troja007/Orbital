# New Credentials Logons Monitoring

## Catalog Identity

- Catalog ID: `new_credentials_logons_monitoring`
- Catalog name: `New Credentials Logons Monitoring`
- Platform: windows
...
- Returned labels:
- `new_credentials_logons_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `new_credentials_logons_monitoring` | `TimeGenerated`, `Message`, `EventIdentifier`, `SourceName`, `Logfile`, `TimeWritten`, `Type` |

Label row counts:
- `new_credentials_logons_monitoring`: 1
