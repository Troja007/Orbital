# Windows Defender Spynet Registry Configuration Monitoring

## Catalog Identity

- Catalog ID: `windows_defender_spynet_registry_monitoring`
- Catalog name: `Windows Defender Spynet Registry Configuration Monitoring`
- Platform: windows
...
- Returned labels:
- `windows_defender_spynet_registry_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_defender_spynet_registry_monitoring` | `reg_key`, `path`, `name`, `data`, `last_modified` |

Label row counts:
- `windows_defender_spynet_registry_monitoring`: 2
