# YARA Scan: PE Contains Few Imports and Dynamic Loading Functions

## Catalog Identity

- Catalog ID: `windows_yara_pe_dynamic_load`
- Catalog name: `YARA Scan: PE Contains Few Imports and Dynamic Loading Functions`
- Platform: windows
