# Windows Recent Files Monitoring

## Catalog Identity

- Catalog ID: `windows_most_recent_files_monitoring`
- Catalog name: `Windows Recent Files Monitoring`
- Platform: windows
...
- Returned labels:
- `windows_most_recent_files_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_most_recent_files_monitoring` | `path`, `filename`, `uid`, `gid`, `mode`, `size`, `last_access_time`, `last_modified`, `last_status_change_time`, `creation_time`, `hard_links`, `symlink`, `type` |

Label row counts:
- `windows_most_recent_files_monitoring`: 13
