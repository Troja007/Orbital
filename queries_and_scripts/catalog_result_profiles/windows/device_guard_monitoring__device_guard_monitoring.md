...
- Catalog ID: `device_guard_monitoring`
- Catalog name: `Device Guard Monitoring`
- Platform: windows
...
- Returned labels:
- `device_guard_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `device_guard_monitoring` | `AvailableSecurityProperties`, `CodeIntegrityPolicyEnforcementStatus`, `RequiredSecurityProperties`, `SecurityServicesConfigured`, `SecurityServicesRunning`, `UsermodeCodeIntegrityPolicyEnforcementStatus`, `VirtualizationBasedSecurityStatus` |

Label row counts:
- `device_guard_monitoring`: 1
