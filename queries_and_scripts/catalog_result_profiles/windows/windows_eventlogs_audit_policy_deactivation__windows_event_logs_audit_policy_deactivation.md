# Windows Event Logs: Audit Policy Deactivation

## Catalog Identity

- Catalog ID: `windows_eventlogs_audit_policy_deactivation`
- Catalog name: `Windows Event Logs: Audit Policy Deactivation`
- Platform: windows
