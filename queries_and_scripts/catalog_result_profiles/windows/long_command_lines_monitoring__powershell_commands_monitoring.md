# PowerShell Commands Monitoring

## Catalog Identity

- Catalog ID: `long_command_lines_monitoring`
- Catalog name: `PowerShell Commands Monitoring`
- Platform: windows
