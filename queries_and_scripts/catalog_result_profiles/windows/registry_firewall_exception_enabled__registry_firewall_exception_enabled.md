# Registry Firewall Exception Enabled

## Catalog Identity

- Catalog ID: `registry_firewall_exception_enabled`
- Catalog name: `Registry Firewall Exception Enabled`
- Platform: windows
