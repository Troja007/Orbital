...
- Catalog ID: `uptime_based_search`
- Catalog name: `Host Uptime Search`
...
| Label | Columns |
| --- | --- |
| `host_uptime_search` | `days`, `hours`, `minutes`, `seconds` |

Label row counts:
- `host_uptime_search`: 1
