# Browser Helper Objects Monitoring

## Catalog Identity

- Catalog ID: `browser_helper_objects`
- Catalog name: `Browser Helper Objects Monitoring`
- Platform: windows
...
| Label | Columns |
| --- | --- |
| `browser_helper_objects` | `reg_key`, `path`, `name`, `data`, `last_modified` |

Label row counts:
- `browser_helper_objects`: 2
