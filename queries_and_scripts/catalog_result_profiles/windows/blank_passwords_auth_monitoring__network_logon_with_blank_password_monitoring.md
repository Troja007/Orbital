# Network Logon With Blank Password Monitoring

## Catalog Identity

- Catalog ID: `blank_passwords_auth_monitoring`
- Catalog name: `Network Logon With Blank Password Monitoring`
- Platform: windows
