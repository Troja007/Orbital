# Windows Registry Default Browser

## Catalog Identity

- Catalog ID: `windows_registry_default_browser`
- Catalog name: `Windows Registry Default Browser`
- Platform: windows
...
- Returned labels:
- `windows_registry_default_browser`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_registry_default_browser` | `path`, `protocol`, `name`, `data`, `last_modified` |

Label row counts:
- `windows_registry_default_browser`: 2
