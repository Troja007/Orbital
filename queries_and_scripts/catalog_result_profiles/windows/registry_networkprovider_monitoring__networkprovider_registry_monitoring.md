# Networkprovider Registry Monitoring

## Catalog Identity

- Catalog ID: `registry_networkprovider_monitoring`
- Catalog name: `Networkprovider Registry Monitoring`
- Platform: windows
...
- Returned labels:
- `networkprovider_registry`

Observed columns:

| Label | Columns |
| --- | --- |
| `networkprovider_registry` | `reg_key`, `path`, `name`, `data`, `last_modified` |

Label row counts:
- `networkprovider_registry`: 3
