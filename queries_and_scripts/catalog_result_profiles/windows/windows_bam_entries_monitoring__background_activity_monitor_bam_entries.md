# Background Activity Monitor (BAM) Entries

## Catalog Identity

- Catalog ID: `windows_bam_entries_monitoring`
- Catalog name: `Background Activity Monitor (BAM) Entries`
- Platform: windows
...
| Label | Columns |
| --- | --- |
| `windows_bam_entries_monitoring` | `sid`, `username`, `path`, `last_execution_time` |

Label row counts:
- `windows_bam_entries_monitoring`: 56

## How To Read The Result

Observed validation result:

The endpoint answered and returned 56 rows in the validation run.
