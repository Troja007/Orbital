# Windows Event Logs: Computer Account Created

## Catalog Identity

- Catalog ID: `windows_eventlogs_computer_account_created`
- Catalog name: `Windows Event Logs: Computer Account Created`
- Platform: windows
