# Credential Validation Events Monitoring

## Catalog Identity

- Catalog ID: `windows_eventlogs_credential_validation_attempt`
- Catalog name: `Credential Validation Events Monitoring`
- Platform: windows
