# YARA Scan: Binary Contains a WMI command

## Catalog Identity

- Catalog ID: `windows_yara_binary_contains_wmi_command`
- Catalog name: `YARA Scan: Binary Contains a WMI command`
- Platform: windows
