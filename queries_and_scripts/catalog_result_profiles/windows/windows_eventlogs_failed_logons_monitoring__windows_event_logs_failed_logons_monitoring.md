# Windows Event Logs: Failed Logons Monitoring

## Catalog Identity

- Catalog ID: `windows_eventlogs_failed_logons_monitoring`
- Catalog name: `Windows Event Logs: Failed Logons Monitoring`
- Platform: windows
