# Windows Registry Application Disallowed to Run

## Catalog Identity

- Catalog ID: `windows_registry_disallow_run`
- Catalog name: `Windows Registry Application Disallowed to Run`
- Platform: windows
