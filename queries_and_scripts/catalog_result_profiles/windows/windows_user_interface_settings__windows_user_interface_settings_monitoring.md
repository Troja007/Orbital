# Windows User Interface Settings Monitoring

## Catalog Identity

- Catalog ID: `windows_user_interface_settings`
- Catalog name: `Windows User Interface Settings Monitoring`
- Platform: windows
...
- Observed row count: 9
- Row-count bucket: `low_1_10`
- Returned labels:
- `windows_user_interface_settings`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_user_interface_settings` | `reg_key`, `path`, `name`, `data`, `last_modified` |

Label row counts:
- `windows_user_interface_settings`: 9

## How To Read The Result

Observed validation result:

The endpoint answered and returned 9 rows in the validation run.
