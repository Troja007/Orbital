# Direct Logons for Service/Computer Accounts Monitoring

## Catalog Identity

- Catalog ID: `windows_direct_service_computer_logons_monitoring`
- Catalog name: `Direct Logons for Service/Computer Accounts Monitoring`
- Platform: windows
...
| Label | Columns |
| --- | --- |
| `windows_direct_service_computer_logons_monitoring` | `Time Generated`, `Message`, `Logon_Type`, `Account_Name`, `LogFile`, `SourceName` |

Label row counts:
- `windows_direct_service_computer_logons_monitoring`: 763

## How To Read The Result

Observed validation result:

The endpoint answered and returned 763 rows in the validation run.
