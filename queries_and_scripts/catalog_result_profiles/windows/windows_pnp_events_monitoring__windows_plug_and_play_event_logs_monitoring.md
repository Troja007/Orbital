# Windows Plug And Play Event Logs Monitoring

## Catalog Identity

- Catalog ID: `windows_pnp_events_monitoring`
- Catalog name: `Windows Plug And Play Event Logs Monitoring`
- Platform: windows
