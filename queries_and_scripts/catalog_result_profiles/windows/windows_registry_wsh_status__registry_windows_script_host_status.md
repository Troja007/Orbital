# Registry Windows Script Host Status

## Catalog Identity

- Catalog ID: `windows_registry_wsh_status`
- Catalog name: `Registry Windows Script Host Status`
- Platform: windows
