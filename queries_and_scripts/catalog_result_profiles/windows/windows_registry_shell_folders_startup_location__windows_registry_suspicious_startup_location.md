# Windows Registry Suspicious Startup Location

## Catalog Identity

- Catalog ID: `windows_registry_shell_folders_startup_location`
- Catalog name: `Windows Registry Suspicious Startup Location`
- Platform: windows
...
- Returned labels:
- `windows_registry_shell_folders_startup_location`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_registry_shell_folders_startup_location` | `path`, `name`, `data`, `last_modified` |

Label row counts:
- `windows_registry_shell_folders_startup_location`: 1
