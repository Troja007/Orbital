# System Assessment Report Monitoring

## Catalog Identity

- Catalog ID: `system_assessment_report_monitoring`
- Catalog name: `System Assessment Report Monitoring`
- Platform: windows
...
- Returned labels:
- `system_assessment_report_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `system_assessment_report_monitoring` | `CPU Score`, `Disk Score`, `Graphics Score`, `Memory Score`, `WinSAT Assessment State`, `WinSPR Level` |

Label row counts:
- `system_assessment_report_monitoring`: 1
