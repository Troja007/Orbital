# Security Support Providers Monitoring

## Catalog Identity

- Catalog ID: `windows_security_support_providers_monitoring`
- Catalog name: `Security Support Providers Monitoring`
- Platform: windows
...
- Returned labels:
- `windows_security_support_providers_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_security_support_providers_monitoring` | `reg_key`, `path`, `name`, `data`, `last_modified` |

Label row counts:
- `windows_security_support_providers_monitoring`: 1
