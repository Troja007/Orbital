# Directory Services Restore Mode (DSRM) Password Changed

## Catalog Identity

- Catalog ID: `windows_eventlogs_dsrm_password_changed`
- Catalog name: `Directory Services Restore Mode (DSRM) Password Changed`
- Platform: windows
