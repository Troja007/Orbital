# Password Settings Monitoring

## Catalog Identity

- Catalog ID: `password_settings_monitoring`
- Catalog name: `Password Settings Monitoring`
- Platform: windows
