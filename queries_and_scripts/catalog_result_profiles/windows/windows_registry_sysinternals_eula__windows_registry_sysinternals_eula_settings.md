# Windows Registry Sysinternals EULA Settings

## Catalog Identity

- Catalog ID: `windows_registry_sysinternals_eula`
- Catalog name: `Windows Registry Sysinternals EULA Settings`
- Platform: windows
...
- Returned labels:
- `windows_registry_sysinternals_eula`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_registry_sysinternals_eula` | `path`, `utility`, `name`, `data`, `last_modified` |

Label row counts:
- `windows_registry_sysinternals_eula`: 1
