# Trusted CA Certificates Search

## Catalog Identity

- Catalog ID: `on_host_certificates_search`
- Catalog name: `Trusted CA Certificates Search`
...
| Label | Columns |
| --- | --- |
| `certificates_search` | `common_name`, `subject`, `issuer`, `ca`, `self_signed`, `not_valid_before`, `not_valid_after`, `sha1`, `path`, `serial` |

Label row counts:
- `certificates_search`: 787

## How To Read The Result

Observed validation result:

The endpoint answered and returned 787 rows in the validation run.
