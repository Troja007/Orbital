# Windows Event Logs for Print Spooler Failed Plug-in Loads

## Catalog Identity

- Catalog ID: `windows_eventlogs_print_spooler_plugin_load`
- Catalog name: `Windows Event Logs for Print Spooler Failed Plug-in Loads`
- Platform: windows
