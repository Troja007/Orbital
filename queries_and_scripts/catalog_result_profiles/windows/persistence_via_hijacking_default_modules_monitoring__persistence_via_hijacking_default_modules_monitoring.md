# Persistence via Hijacking Default Modules Monitoring

## Catalog Identity

- Catalog ID: `persistence_via_hijacking_default_modules_monitoring`
- Catalog name: `Persistence via Hijacking Default Modules Monitoring`
- Platform: windows
...
Catalog warnings:
- This query searches process data from Windows eventlog's audit logs. If the Windows's process event/audit logging is disabled, then this query will not return any data.
