# Windows Registry 32-bit Applications with DEP exclusion

## Catalog Identity

- Catalog ID: `windows_registry_32bit_dep_exclusion`
- Catalog name: `Windows Registry 32-bit Applications with DEP exclusion`
- Platform: windows
...
- Returned labels:
- `windows_registry_32bit_dep_exclusion`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_registry_32bit_dep_exclusion` | `path`, `name`, `data`, `sha256`, `last_modified` |

Label row counts:
- `windows_registry_32bit_dep_exclusion`: 2
