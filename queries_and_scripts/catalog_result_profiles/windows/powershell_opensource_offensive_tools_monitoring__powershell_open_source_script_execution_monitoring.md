# Powershell Open Source Script Execution Monitoring

## Catalog Identity

- Catalog ID: `powershell_opensource_offensive_tools_monitoring`
- Catalog name: `Powershell Open Source Script Execution Monitoring`
- Platform: windows
...
- Returned labels:
- `orbital_powershell_opensource_scripts_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `orbital_powershell_opensource_scripts_monitoring` | `time`, `datetime`, `script_name`, `script_path`, `script_text`, `script_block_id`, `script_block_count` |

Label row counts:
- `orbital_powershell_opensource_scripts_monitoring`: 2
