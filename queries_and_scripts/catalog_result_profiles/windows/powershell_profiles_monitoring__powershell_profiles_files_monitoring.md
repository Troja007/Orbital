# PowerShell Profiles Files Monitoring

## Catalog Identity

- Catalog ID: `powershell_profiles_monitoring`
- Catalog name: `PowerShell Profiles Files Monitoring`
- Platform: windows
