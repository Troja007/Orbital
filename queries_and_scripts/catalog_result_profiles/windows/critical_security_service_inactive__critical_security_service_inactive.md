# Critical Security Service Inactive

## Catalog Identity

- Catalog ID: `critical_security_service_inactive`
- Catalog name: `Critical Security Service Inactive`
- Platform: windows
...
- Returned labels:
- `critical_security_service_inactive`

Observed columns:

| Label | Columns |
| --- | --- |
| `critical_security_service_inactive` | `name`, `display_name`, `pid`, `path`, `user_account`, `start_type`, `module_path` |

Label row counts:
- `critical_security_service_inactive`: 1
