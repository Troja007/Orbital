# IE Phishing Filter Disabled Monitoring

## Catalog Identity

- Catalog ID: `ie_phishing_filter_disabled_monitoring`
- Catalog name: `IE Phishing Filter Disabled Monitoring`
- Platform: windows
