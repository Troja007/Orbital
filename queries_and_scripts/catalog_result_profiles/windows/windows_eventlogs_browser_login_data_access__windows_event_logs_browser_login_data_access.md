# Windows Event Logs Browser Login Data Access

## Catalog Identity

- Catalog ID: `windows_eventlogs_browser_login_data_access`
- Catalog name: `Windows Event Logs Browser Login Data Access`
- Platform: windows
