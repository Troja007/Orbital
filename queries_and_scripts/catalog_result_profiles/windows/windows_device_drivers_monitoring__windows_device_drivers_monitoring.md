# Windows Device Drivers Monitoring

## Catalog Identity

- Catalog ID: `windows_device_drivers_monitoring`
- Catalog name: `Windows Device Drivers Monitoring`
- Platform: windows
...
- Observed row count: 122
- Row-count bucket: `high_101_1000`
- Returned labels:
- `windows_device_drivers_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_device_drivers_monitoring` | `device_id`, `device_name`, `image`, `description`, `service`, `service_key`, `version`, `inf`, `class`, `provider`, `manufacturer`, `driver_key`, `Driver_date`, `signed` |

Label row counts:
- `windows_device_drivers_monitoring`: 122

## How To Read The Result

Observed validation result:

The endpoint answered and returned 122 rows in the validation run.
