# Windows Event Logs for Kerberos Service Ticket Request

## Catalog Identity

- Catalog ID: `windows_eventlogs_kerberos_service_ticket_requests`
- Catalog name: `Windows Event Logs for Kerberos Service Ticket Request`
- Platform: windows
