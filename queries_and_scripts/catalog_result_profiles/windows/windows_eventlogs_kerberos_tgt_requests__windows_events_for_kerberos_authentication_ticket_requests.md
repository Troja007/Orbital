# Windows Events for Kerberos Authentication Ticket Requests

## Catalog Identity

- Catalog ID: `windows_eventlogs_kerberos_tgt_requests`
- Catalog name: `Windows Events for Kerberos Authentication Ticket Requests`
- Platform: windows
