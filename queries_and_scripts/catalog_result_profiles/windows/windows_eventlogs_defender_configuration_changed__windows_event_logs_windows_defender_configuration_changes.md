# Windows Event Logs: Windows Defender Configuration Changes

## Catalog Identity

- Catalog ID: `windows_eventlogs_defender_configuration_changed`
- Catalog name: `Windows Event Logs: Windows Defender Configuration Changes`
- Platform: windows
...
| Label | Columns |
| --- | --- |
| `windows_eventlogs_defender_configuration_changed` | `datetime`, `old_value`, `new_value`, `data` |

Label row counts:
- `windows_eventlogs_defender_configuration_changed`: 764

## How To Read The Result

Observed validation result:

The endpoint answered and returned 764 rows in the validation run.
