# Windows Services Event Logs Monitoring

## Catalog Identity

- Catalog ID: `windows_services_events_monitoring`
- Catalog name: `Windows Services Event Logs Monitoring`
- Platform: windows
...
- Observed row count: 850
- Row-count bucket: `high_101_1000`
- Returned labels:
- `windows_services_events_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_services_events_monitoring` | `TimeGenerated`, `Message`, `EventIdentifier`, `SourceName`, `Logfile`, `TimeWritten`, `Type` |

Label row counts:
- `windows_services_events_monitoring`: 850

## How To Read The Result

Observed validation result:

The endpoint answered and returned 850 rows in the validation run.
