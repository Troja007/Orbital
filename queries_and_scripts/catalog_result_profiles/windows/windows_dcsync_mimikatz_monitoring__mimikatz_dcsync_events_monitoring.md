# Mimikatz DCSync Events Monitoring

## Catalog Identity

- Catalog ID: `windows_dcsync_mimikatz_monitoring`
- Catalog name: `Mimikatz DCSync Events Monitoring`
- Platform: windows
