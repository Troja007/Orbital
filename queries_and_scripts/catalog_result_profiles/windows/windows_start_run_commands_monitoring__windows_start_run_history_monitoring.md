# Windows Start/Run History Monitoring

## Catalog Identity

- Catalog ID: `windows_start_run_commands_monitoring`
- Catalog name: `Windows Start/Run History Monitoring`
- Platform: windows
...
- Returned labels:
- `windows_start_run_commands_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_start_run_commands_monitoring` | `reg_key`, `path`, `name`, `data`, `last_modified` |

Label row counts:
- `windows_start_run_commands_monitoring`: 3
