# CVE-2020-1472 Monitoring 2.0.0

## Catalog Identity

- Catalog ID: `windows_cve_2020_1472_monitoring_v2`
- Catalog name: `CVE-2020-1472 Monitoring 2.0.0`
- Platform: windows
...
- Returned labels:
- `windows_cve_2020_1472_patches_v2`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_cve_2020_1472_patches_v2` | `name`, `kb_installed`, `enforcement_mode_status`, `enforcement_mode_status_last_modified`, `CVE_2020_1472_Status` |

Label row counts:
- `windows_cve_2020_1472_patches_v2`: 1
