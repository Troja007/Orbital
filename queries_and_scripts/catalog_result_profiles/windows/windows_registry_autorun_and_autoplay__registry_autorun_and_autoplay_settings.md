# Registry AutoRun and AutoPlay Settings

## Catalog Identity

- Catalog ID: `windows_registry_autorun_and_autoplay`
- Catalog name: `Registry AutoRun and AutoPlay Settings`
- Platform: windows
...
- Returned labels:
- `windows_registry_autorun_and_autoplay`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_registry_autorun_and_autoplay` | `path`, `name`, `data`, `last_modified` |

Label row counts:
- `windows_registry_autorun_and_autoplay`: 4
