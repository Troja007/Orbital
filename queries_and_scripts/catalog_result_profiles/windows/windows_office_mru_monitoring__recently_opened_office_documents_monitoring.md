# Recently Opened Office Documents Monitoring

## Catalog Identity

- Catalog ID: `windows_office_mru_monitoring`
- Catalog name: `Recently Opened Office Documents Monitoring`
- Platform: windows
