# Windows Registry Network Settings

## Catalog Identity

- Catalog ID: `windows_registry_network_settings`
- Catalog name: `Windows Registry Network Settings`
- Platform: windows
...
- Returned labels:
- `windows_registry_network_settings`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_registry_network_settings` | `path`, `zone_name`, `zone_authentication`, `data`, `last_modified` |

Label row counts:
- `windows_registry_network_settings`: 5
