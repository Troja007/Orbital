# Registry Cached Logon Count Monitoring

## Catalog Identity

- Catalog ID: `windows_registry_cached_logons_count`
- Catalog name: `Registry Cached Logon Count Monitoring`
- Platform: windows
...
- Returned labels:
- `windows_registry_cached_logons_count`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_registry_cached_logons_count` | `name`, `data`, `last_modified` |

Label row counts:
- `windows_registry_cached_logons_count`: 1
