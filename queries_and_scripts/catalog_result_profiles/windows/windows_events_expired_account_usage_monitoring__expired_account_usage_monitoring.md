# Expired Account Usage Monitoring

## Catalog Identity

- Catalog ID: `windows_events_expired_account_usage_monitoring`
- Catalog name: `Expired Account Usage Monitoring`
- Platform: windows
