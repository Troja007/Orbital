# Windows Event Logs: Denied RDP Connection with Valid Credentials

## Catalog Identity

- Catalog ID: `windows_eventlogs_denied_rdp_connection_valid_cred`
- Catalog name: `Windows Event Logs: Denied RDP Connection with Valid Credentials`
- Platform: windows
