# Windows AntiVirus Products Monitoring

## Catalog Identity

- Catalog ID: `windows_av_products_monitoring`
- Catalog name: `Windows AntiVirus Products Monitoring`
- Platform: windows
