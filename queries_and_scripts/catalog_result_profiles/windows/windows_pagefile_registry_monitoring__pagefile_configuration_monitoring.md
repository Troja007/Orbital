# Pagefile Configuration Monitoring

## Catalog Identity

- Catalog ID: `windows_pagefile_registry_monitoring`
- Catalog name: `Pagefile Configuration Monitoring`
- Platform: windows
