# Application Shims Monitoring

## Catalog Identity

- Catalog ID: `windows_shims_monitoring`
- Catalog name: `Application Shims Monitoring`
- Platform: windows
