# Outlook Loaded Suspicious DLLs

## Catalog Identity

- Catalog ID: `windows_outlook_loaded_suspicious_dll`
- Catalog name: `Outlook Loaded Suspicious DLLs`
- Platform: windows
