# Windows PowerShell Events Get-Process Monitoring

## Catalog Identity

- Catalog ID: `windows_powershell_events_get_process`
- Catalog name: `Windows PowerShell Events Get-Process Monitoring`
- Platform: windows
