# Windows Event Logs Restrictions Monitoring

## Catalog Identity

- Catalog ID: `registry_event_log_restrictions_monitoring`
- Catalog name: `Windows Event Logs Restrictions Monitoring`
- Platform: windows
