# Boot Configuration Data Windows Event Logs

## Catalog Identity

- Catalog ID: `windows_eventlogs_kernel_debugging_on`
- Catalog name: `Boot Configuration Data Windows Event Logs`
- Platform: windows
