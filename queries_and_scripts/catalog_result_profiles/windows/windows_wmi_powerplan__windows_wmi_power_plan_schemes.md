# Windows WMI Power Plan Schemes

## Catalog Identity

- Catalog ID: `windows_wmi_powerplan`
- Catalog name: `Windows WMI Power Plan Schemes`
- Platform: windows
...
- Returned labels:
- `windows_wmi_powerplan`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_wmi_powerplan` | `Description`, `ElementName`, `is_active` |

Label row counts:
- `windows_wmi_powerplan`: 3
