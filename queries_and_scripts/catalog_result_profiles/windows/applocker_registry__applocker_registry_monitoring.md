# Applocker Registry Monitoring

## Catalog Identity

- Catalog ID: `applocker_registry`
- Catalog name: `Applocker Registry Monitoring`
- Platform: windows
