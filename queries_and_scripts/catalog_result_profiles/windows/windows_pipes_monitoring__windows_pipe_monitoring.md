# Windows Pipe Monitoring

## Catalog Identity

- Catalog ID: `windows_pipes_monitoring`
- Catalog name: `Windows Pipe Monitoring`
- Platform: windows
...
| Label | Columns |
| --- | --- |
| `windows_pipe` | `name`, `instances`, `max_instances`, `flags`, `path` |
...
The endpoint answered and returned 55 rows in the validation run.
