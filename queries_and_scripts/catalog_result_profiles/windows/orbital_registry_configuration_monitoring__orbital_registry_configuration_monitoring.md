# Orbital Registry Configuration Monitoring

## Catalog Identity

- Catalog ID: `orbital_registry_configuration_monitoring`
- Catalog name: `Orbital Registry Configuration Monitoring`
- Platform: windows
...
- Observed row count: 19
- Row-count bucket: `medium_11_100`
- Returned labels:
- `orbital_registry_configuration`

Observed columns:

| Label | Columns |
| --- | --- |
| `orbital_registry_configuration` | `reg_key`, `path`, `name`, `data`, `last_modified` |

Label row counts:
- `orbital_registry_configuration`: 19

## How To Read The Result

Observed validation result:

The endpoint answered and returned 19 rows in the validation run.
