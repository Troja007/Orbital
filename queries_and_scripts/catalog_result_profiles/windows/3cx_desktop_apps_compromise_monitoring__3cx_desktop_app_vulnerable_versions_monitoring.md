# 3CX Desktop App Vulnerable Versions Monitoring

## Catalog Identity

- Catalog ID: `3cx_desktop_apps_compromise_monitoring`
- Catalog name: `3CX Desktop App Vulnerable Versions Monitoring`
