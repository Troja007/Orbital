# Parent Process Not Wininit

## Catalog Identity

- Catalog ID: `parent_process_not_wininit`
- Catalog name: `Parent Process Not Wininit`
- Platform: windows
