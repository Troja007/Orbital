# Registry Uninstall Entries Monitoring

## Catalog Identity

- Catalog ID: `windows_registry_uninstall_entries`
- Catalog name: `Registry Uninstall Entries Monitoring`
- Platform: windows
...
- Returned labels:
- `windows_registry_uninstall_entries`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_registry_uninstall_entries` | `key`, `name`, `data`, `last_modified` |

Label row counts:
- `windows_registry_uninstall_entries`: 1
