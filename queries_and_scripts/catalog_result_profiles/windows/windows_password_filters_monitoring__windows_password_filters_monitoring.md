# Windows Password Filters Monitoring

## Catalog Identity

- Catalog ID: `windows_password_filters_monitoring`
- Catalog name: `Windows Password Filters Monitoring`
- Platform: windows
...
- Returned labels:
- `windows_password_filters_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_password_filters_monitoring` | `reg_key`, `path`, `name`, `data`, `last_modified` |

Label row counts:
- `windows_password_filters_monitoring`: 1
