# Extracting Backup Key Windows Events Monitoring

## Catalog Identity

- Catalog ID: `windows_events_extracting_backup_key_monitoring`
- Catalog name: `Extracting Backup Key Windows Events Monitoring`
- Platform: windows
