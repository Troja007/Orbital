# Windows Trusted Platform Module Monitoring

## Catalog Identity

- Catalog ID: `windows_tmp_monitoring`
- Catalog name: `Windows Trusted Platform Module Monitoring`
- Platform: windows
