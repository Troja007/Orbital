...
- Catalog ID: `scheduled_tasks_param_search`
- Catalog name: `Scheduled Task Search`
- Platform: windows
...
- Observed row count: 239
- Row-count bucket: `high_101_1000`
- Returned labels:
- `scheduled_task_search`

Observed columns:

| Label | Columns |
| --- | --- |
| `scheduled_task_search` | `name`, `action`, `path`, `enabled`, `state`, `hidden`, `last_run_time`, `next_run_time`, `last_run_message`, `last_run_code` |

Label row counts:
- `scheduled_task_search`: 239

## How To Read The Result

Observed validation result:

The endpoint answered and returned 239 rows in the validation run.
