# Windowd User Acess Control Prompt Behavior Monitoring

## Catalog Identity

- Catalog ID: `windows_uac_prompt_behavior_monitoring`
- Catalog name: `Windowd User Acess Control Prompt Behavior Monitoring`
- Platform: windows
...
- Returned labels:
- `windows_uac_prompt_behavior_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_uac_prompt_behavior_monitoring` | `reg_key`, `path`, `name`, `data`, `last_modified` |

Label row counts:
- `windows_uac_prompt_behavior_monitoring`: 2
