# Scheduled Tasks From AppData Directory Monitoring

## Catalog Identity

- Catalog ID: `scheduled_tasks_from_appdata_monitoring`
- Catalog name: `Scheduled Tasks From AppData Directory Monitoring`
- Platform: windows
