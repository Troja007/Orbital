# PuTTY Sessions Registry Key Monitoring

## Catalog Identity

- Catalog ID: `putty_sessions_registry_monitoring`
- Catalog name: `PuTTY Sessions Registry Key Monitoring`
- Platform: windows
