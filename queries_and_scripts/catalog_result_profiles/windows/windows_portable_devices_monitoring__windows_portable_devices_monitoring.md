# Windows Portable Devices Monitoring

## Catalog Identity

- Catalog ID: `windows_portable_devices_monitoring`
- Catalog name: `Windows Portable Devices Monitoring`
- Platform: windows
