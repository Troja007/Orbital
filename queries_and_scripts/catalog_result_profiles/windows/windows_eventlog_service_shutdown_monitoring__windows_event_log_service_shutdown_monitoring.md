# Windows Event Log Service Shutdown Monitoring

## Catalog Identity

- Catalog ID: `windows_eventlog_service_shutdown_monitoring`
- Catalog name: `Windows Event Log Service Shutdown Monitoring`
- Platform: windows
...
- Returned labels:
- `windows_eventlog_service_shutdown_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_eventlog_service_shutdown_monitoring` | `datetime`, `subject_user_name`, `target_user_name`, `target_domain_name`, `data` |

Label row counts:
- `windows_eventlog_service_shutdown_monitoring`: 8
