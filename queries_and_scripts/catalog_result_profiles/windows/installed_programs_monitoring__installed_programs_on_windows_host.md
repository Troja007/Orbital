...
- Catalog ID: `installed_programs_monitoring`
- Catalog name: `Installed Programs On Windows Host`
- Platform: windows
...
The endpoint answered and returned 31 rows in the validation run.
