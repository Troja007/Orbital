# Windows Printer Port Monitors

## Catalog Identity

- Catalog ID: `windows_printer_port_monitors`
- Catalog name: `Windows Printer Port Monitors`
- Platform: windows
...
- Returned labels:
- `windows_printer_port_monitors`

Observed columns:

| Label | Columns |
| --- | --- |
| `windows_printer_port_monitors` | `reg_key`, `path`, `name`, `data`, `last_modified` |

Label row counts:
- `windows_printer_port_monitors`: 4
