# Remote Interactive Logon Event Monitoring

## Catalog Identity

- Catalog ID: `remote_interactive_logon_event_monitoring`
- Catalog name: `Remote Interactive Logon Event Monitoring`
- Platform: windows
...
- Returned labels:
- `remote_interactive_logon_event_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `remote_interactive_logon_event_monitoring` | `RemoteIP`, `RemotePort`, `AuthenticationPackage`, `TimeGenerated`, `Message`, `EventIdentifier`, `SourceName`, `LogFile`, `TimeWritten`, `Type` |

Label row counts:
- `remote_interactive_logon_event_monitoring`: 11
