# Aedebug Registry Key Monitoring

## Catalog Identity

- Catalog ID: `aedebug_registry_key_monitoring`
- Catalog name: `Aedebug Registry Key Monitoring`
- Platform: windows
...
- Returned labels:
- `aedebug_registry_key`

Observed columns:

| Label | Columns |
| --- | --- |
| `aedebug_registry_key` | `reg_key`, `path`, `name`, `data`, `last_modified` |

Label row counts:
- `aedebug_registry_key`: 4
