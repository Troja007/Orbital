# Hardware Encryption Monitoring

## Catalog Identity

- Catalog ID: `bitlocker_hardware_encryption_monitoring`
- Catalog name: `Hardware Encryption Monitoring`
- Platform: windows
