# Windows Registry Hidden User Accounts Monitoring

## Catalog Identity

- Catalog ID: `windows_registry_hidden_user_accounts`
- Catalog name: `Windows Registry Hidden User Accounts Monitoring`
- Platform: windows
