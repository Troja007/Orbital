# Exe File Registry Key IsolatedCommand Monitoring

## Catalog Identity

- Catalog ID: `sdclt_bypass_registry_isolatedcommand_key`
- Catalog name: `Exe File Registry Key IsolatedCommand Monitoring`
- Platform: windows
...
- Returned labels:
- `sdclt_bypass_registry_isolatedcommand_key`

Observed columns:

| Label | Columns |
| --- | --- |
| `sdclt_bypass_registry_isolatedcommand_key` | `reg_key`, `path`, `name`, `data`, `last_modified` |

Label row counts:
- `sdclt_bypass_registry_isolatedcommand_key`: 2
