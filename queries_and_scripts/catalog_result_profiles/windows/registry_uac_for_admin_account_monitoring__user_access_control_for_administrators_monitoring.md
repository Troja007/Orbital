# User Access Control For Administrators Monitoring

## Catalog Identity

- Catalog ID: `registry_uac_for_admin_account_monitoring`
- Catalog name: `User Access Control For Administrators Monitoring`
- Platform: windows
...
- Returned labels:
- `registry_uac_for_admin_account_monitoring`

Observed columns:

| Label | Columns |
| --- | --- |
| `registry_uac_for_admin_account_monitoring` | `UAC for Built-in Administrator Account`, `Last Modified` |

Label row counts:
- `registry_uac_for_admin_account_monitoring`: 1
