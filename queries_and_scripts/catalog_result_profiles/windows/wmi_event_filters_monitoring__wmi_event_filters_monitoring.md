...
- Catalog ID: `wmi_event_filters_monitoring`
- Catalog name: `WMI Event Filters Monitoring`
- Platform: windows
...
| Label | Columns |
| --- | --- |
| `wmi_event_filters` | `name`, `query`, `query_language`, `class`, `relative_path` |
