# Local Group Membership Enumeration Monitoring

## Catalog Identity

- Catalog ID: `local_group_membership_enumeration_monitoring`
- Catalog name: `Local Group Membership Enumeration Monitoring`
- Platform: windows
