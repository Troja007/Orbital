# Firewall Authorized Applications Monitoring

## Catalog Identity

- Catalog ID: `registry_firewall_authorized_applications`
- Catalog name: `Firewall Authorized Applications Monitoring`
- Platform: windows
...
- Returned labels:
- `firewall_authorized_applications`

Observed columns:

| Label | Columns |
| --- | --- |
| `firewall_authorized_applications` | `Authorized Application`, `last_modified` |

Label row counts:
- `firewall_authorized_applications`: 20
