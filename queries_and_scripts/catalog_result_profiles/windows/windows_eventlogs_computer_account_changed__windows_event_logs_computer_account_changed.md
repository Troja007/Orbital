# Windows Event Logs Computer Account Changed

## Catalog Identity

- Catalog ID: `windows_eventlogs_computer_account_changed`
- Catalog name: `Windows Event Logs Computer Account Changed`
- Platform: windows
