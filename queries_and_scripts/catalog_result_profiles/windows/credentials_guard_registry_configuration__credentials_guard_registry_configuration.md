# Credentials Guard Registry Configuration

## Catalog Identity

- Catalog ID: `credentials_guard_registry_configuration`
- Catalog name: `Credentials Guard Registry Configuration`
- Platform: windows
...
- Returned labels:
- `credentials_guard_registry_configuration`

Observed columns:

| Label | Columns |
| --- | --- |
| `credentials_guard_registry_configuration` | `reg_key`, `path`, `name`, `data`, `last_modified` |

Label row counts:
- `credentials_guard_registry_configuration`: 3
