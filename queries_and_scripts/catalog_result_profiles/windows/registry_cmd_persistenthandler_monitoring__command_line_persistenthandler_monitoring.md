# Command Line PersistentHandler Monitoring

## Catalog Identity

- Catalog ID: `registry_cmd_persistenthandler_monitoring`
- Catalog name: `Command Line PersistentHandler Monitoring`
- Platform: windows
