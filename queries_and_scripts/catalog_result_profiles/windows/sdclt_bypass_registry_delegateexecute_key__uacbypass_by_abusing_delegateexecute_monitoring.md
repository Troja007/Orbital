# UACBypass by Abusing DelegateExecute Monitoring

## Catalog Identity

- Catalog ID: `sdclt_bypass_registry_delegateexecute_key`
- Catalog name: `UACBypass by Abusing DelegateExecute Monitoring`
- Platform: windows
