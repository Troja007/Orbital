# WMI Command Line Event Consumer Monitoring

## Catalog Identity

- Catalog ID: `wmi_cli_event_consumers_monitoring`
- Catalog name: `WMI Command Line Event Consumer Monitoring`
- Platform: windows
