# Logon Sessions Monitoring

## Catalog Identity

- Catalog ID: `logon_sessions_monitoring`
- Catalog name: `Logon Sessions Monitoring`
- Platform: windows
