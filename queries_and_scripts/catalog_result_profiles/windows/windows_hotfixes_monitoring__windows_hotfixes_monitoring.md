# Windows HotFixes Monitoring

## Catalog Identity

- Catalog ID: `windows_hotfixes_monitoring`
- Catalog name: `Windows HotFixes Monitoring`
- Platform: windows
...
| Label | Columns |
| --- | --- |
| `windows_hotfixes` | `name`, `hotfix_id`, `caption`, `description`, `fix_comments`, `installed_by`, `install_date`, `installed_on` |
...
The endpoint answered and returned 10 rows in the validation run.
...
Catalog warnings:
- Query results do not include patches applied via MSI or downloaded from Windows Update (e.g. Service Packs)
