# System Snapshot Windows 0.0.9 (formerly Forensic Snapshot Windows 0.0.9)

## Catalog Identity

- Catalog ID: `system-snapshot-windows-0.0.9`
- Catalog name: `System Snapshot Windows 0.0.9 (formerly Forensic Snapshot Windows 0.0.9)`
- Platform: windows
...
- `dns_cache_table_monitoring`: 88
- `installed_programs_on_windows_host`: 31
- `interface_names_and_associated_ips`: 1
- `listening_ports`: 11
- `loaded_modules_hashes`: 1756
- `loaded_modules_processes`: 159
- `loaded_modules_vs_processes`: 8024
- `logged_in_users`: 1
...
- `processes_with_network_connections`: 10
...
The endpoint answered and returned 15524 rows in the validation run.
