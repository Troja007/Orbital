...
Project area for active helpers, `query-method-memory`, experiments, and investigation support files.
...
- Product and workflow context now lives at root-level `../product-context/`.
